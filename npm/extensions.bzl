...
- "default": Minimal defaults (README.md)
- "yarn_autoclean": Yarn autoclean defaults (see https://github.com/yarnpkg/yarn/blob/7cafa512a777048ce0b666080a24e80aae3d66a9/src/cli/commands/autoclean.js#L16)
""",
        default = ["default"],
    ),
}
...
By default, `presets` is set to `["default"]` which excludes common files such as `*.md` and development-related
