...
load("@npm__ms__0.7.3__links//:defs.bzl", link_123 = "npm_link_package")
load("@npm__ms__2.0.0__links//:defs.bzl", link_124 = "npm_link_package")
load("@npm__ms__2.1.2__links//:defs.bzl", link_125 = "npm_link_package")
load("@npm__ms__2.1.3__links//:defs.bzl", link_126 = "npm_link_package")
load("@npm__nanoid__3.3.3__links//:defs.bzl", link_127 = "npm_link_package")
load("@npm__node-gyp-build__3.7.0__links//:defs.bzl", link_128 = "npm_link_package")
load("@npm__normalize-path__3.0.0__links//:defs.bzl", link_129 = "npm_link_package")
load("@npm__object-assign__4.1.1__links//:defs.bzl", link_130 = "npm_link_package")
load("@npm__once__1.4.0__links//:defs.bzl", link_131 = "npm_link_package")
load("@npm__opener__1.5.2__links//:defs.bzl", link_132 = "npm_link_package")
load("@npm__optimist__0.6.0__links//:defs.bzl", link_133 = "npm_link_package")
load("@npm__p-limit__3.1.0__links//:defs.bzl", link_134 = "npm_link_package")
load("@npm__p-locate__5.0.0__links//:defs.bzl", link_135 = "npm_link_package")
load("@npm__path-exists__4.0.0__links//:defs.bzl", link_136 = "npm_link_package")
load("@npm__path-is-absolute__1.0.1__links//:defs.bzl", link_137 = "npm_link_package")
load("@npm__path-parse__1.0.7__links//:defs.bzl", link_138 = "npm_link_package")
load("@npm__picomatch__2.3.1__links//:defs.bzl", link_139 = "npm_link_package")
load("@npm__randombytes__2.1.0__links//:defs.bzl", link_140 = "npm_link_package")
load("@npm__react__17.0.2__links//:defs.bzl", link_141 = "npm_link_package")
load("@npm__readdirp__3.6.0__links//:defs.bzl", link_142 = "npm_link_package")
load("@npm__require-directory__2.1.1__links//:defs.bzl", link_143 = "npm_link_package")
load("@npm__resolve__1.22.0__links//:defs.bzl", link_144 = "npm_link_package")
load("@npm__rollup__2.70.2__links//:defs.bzl", link_145 = "npm_link_package")
load("@npm__sade__1.8.1__links//:defs.bzl", link_146 = "npm_link_package")
load("@npm__safe-buffer__5.2.1__links//:defs.bzl", link_147 = "npm_link_package")
load("@npm__serialize-javascript__6.0.0__links//:defs.bzl", link_148 = "npm_link_package")
load("@npm__sirv__1.0.19__links//:defs.bzl", link_149 = "npm_link_package")
load("@npm__sourcemap-codec__1.4.8__links//:defs.bzl", link_150 = "npm_link_package")
load("@npm__string-width__4.2.3__links//:defs.bzl", link_151 = "npm_link_package")
load("@npm__strip-ansi__6.0.1__links//:defs.bzl", link_152 = "npm_link_package")
load("@npm__strip-json-comments__3.1.1__links//:defs.bzl", link_153 = "npm_link_package")
load("@npm__supports-color__7.2.0__links//:defs.bzl", link_154 = "npm_link_package")
load("@npm__supports-color__8.1.1__links//:defs.bzl", link_155 = "npm_link_package")
load("@npm__supports-preserve-symlinks-flag__1.0.0__links//:defs.bzl", link_156 = "npm_link_package")
load("@npm__to-regex-range__5.0.1__links//:defs.bzl", link_157 = "npm_link_package")
load("@npm__totalist__1.1.0__links//:defs.bzl", link_158 = "npm_link_package")
load("@npm__typescript__4.7.2__links//:defs.bzl", link_159 = "npm_link_package")
load("@npm__unused__0.2.2__links//:defs.bzl", link_160 = "npm_link_package")
load("@npm__uvu__0.5.3__links//:defs.bzl", link_161 = "npm_link_package")
load("@npm__webpack-bundle-analyzer__4.5.0__bufferutil_4.0.1__links//:defs.bzl", link_162 = "npm_link_package")
load("@npm__wordwrap__0.0.3__links//:defs.bzl", link_163 = "npm_link_package")
load("@npm__workerpool__6.2.1__links//:defs.bzl", link_164 = "npm_link_package")
load("@npm__wrap-ansi__7.0.0__links//:defs.bzl", link_165 = "npm_link_package")
load("@npm__wrappy__1.0.2__links//:defs.bzl", link_166 = "npm_link_package")
load("@npm__ws__7.5.8__bufferutil_4.0.1__links//:defs.bzl", link_167 = "npm_link_package")
load("@npm__xml__1.0.1__links//:defs.bzl", link_168 = "npm_link_package")
load("@npm__y18n__5.0.8__links//:defs.bzl", link_169 = "npm_link_package")
load("@npm__yargs-parser__20.2.4__links//:defs.bzl", link_170 = "npm_link_package")
load("@npm__yargs-unparser__2.0.0__links//:defs.bzl", link_171 = "npm_link_package")
load("@npm__yargs__16.2.0__links//:defs.bzl", link_172 = "npm_link_package")
load("@npm__yocto-queue__0.1.0__links//:defs.bzl", link_173 = "npm_link_package")
load("@npm__debug__github.com_ngokevin_debug_9742c5f383a6f8046241920156236ade8ec30d53__links//:defs.bzl", link_174 = "npm_link_package")
...
def npm_link_all_packages(name = "node_modules"):
    ...
    """
    root_package = ""
    link_packages = ["", "examples/macro", "examples/npm_deps", "npm/private/test"]
    is_root = native.package_name() == root_package
    is_direct = native.package_name() in link_packages
    if not is_root and not is_direct:
        msg = "The npm_link_all_packages() macro loaded from @npm//:defs.bzl and called in bazel package '%s' may only be called in the bazel package(s) corresponding to the root package '' and packages ['', 'examples/macro', 'examples/npm_deps', 'npm/private/test']" % native.package_name()
        fail(msg)
    direct_targets = []
    ...
    direct_targets.append(link_126(name = "{}/ms".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_127(name = "{}/nanoid".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_128(name = "{}/node-gyp-build".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_129(name = "{}/normalize-path".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_130(name = "{}/object-assign".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_131(name = "{}/once".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_132(name = "{}/opener".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_133(name = "{}/optimist".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_134(name = "{}/p-limit".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_135(name = "{}/p-locate".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_136(name = "{}/path-exists".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_137(name = "{}/path-is-absolute".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_138(name = "{}/path-parse".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_139(name = "{}/picomatch".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_140(name = "{}/randombytes".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_141(name = "{}/react".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_142(name = "{}/readdirp".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_143(name = "{}/require-directory".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_144(name = "{}/resolve".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_145(name = "{}/rollup".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_146(name = "{}/sade".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_147(name = "{}/safe-buffer".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_148(name = "{}/serialize-javascript".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_149(name = "{}/sirv".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_150(name = "{}/sourcemap-codec".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_151(name = "{}/string-width".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_152(name = "{}/strip-ansi".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_153(name = "{}/strip-json-comments".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_154(name = "{}/supports-color".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_155(name = "{}/supports-color".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_156(name = "{}/supports-preserve-symlinks-flag".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_157(name = "{}/to-regex-range".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_158(name = "{}/totalist".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_159(name = "{}/typescript".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_160(name = "{}/unused".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_161(name = "{}/uvu".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_162(name = "{}/webpack-bundle-analyzer".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_163(name = "{}/wordwrap".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_164(name = "{}/workerpool".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_165(name = "{}/wrap-ansi".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_166(name = "{}/wrappy".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_167(name = "{}/ws".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_168(name = "{}/xml".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_169(name = "{}/y18n".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_170(name = "{}/yargs-parser".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_171(name = "{}/yargs-unparser".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_172(name = "{}/yargs".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_173(name = "{}/yocto-queue".format(name), direct = None, fail_if_no_link = False))
    direct_targets.append(link_174(name = "{}/debug".format(name), direct = None, fail_if_no_link = False))
