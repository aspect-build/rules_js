...
TEST_SNAPSHOTS = {
    "@aspect-test/a@5.0.0": {
        ...
        "dependencies": {
            ...
            "@aspect-test/d": "@aspect-test/d@2.0.0_@aspect-test+c@1.0.0",
        },
        "optional_dependencies": {},
    },
    "@aspect-test/b@5.0.0": {
        "package": "@aspect-test/b@5.0.0",
        "dependencies": {},
        "optional_dependencies": {
    ...
    "@aspect-test/c@1.0.0": {
        "package": "@aspect-test/c@1.0.0",
        "dependencies": {},
        "optional_dependencies": {},
    },
    "@aspect-test/c@2.0.0": {
        "package": "@aspect-test/c@2.0.0",
        "dependencies": {},
        "optional_dependencies": {},
    },
    "@aspect-test/d@2.0.0_@aspect-test+c@1.0.0": {
        "package": "@aspect-test/d@2.0.0",
        "dependencies": {},
        "optional_dependencies": {},
    },
}
...
def test_walk_deps(ctx):
    ...
    closure = gather_transitive_closure(TEST_PACKAGES, TEST_SNAPSHOTS, "@aspect-test/a@5.0.0", not_no_optional)
    expected = {"@aspect-test/a@5.0.0": ["@aspect-test/a"], "@aspect-test/b@5.0.0": ["@aspect-test/b"], "@aspect-test/c@1.0.0": ["@aspect-test/c"], "@aspect-test/c@2.0.0": ["@aspect-test/c"], "@aspect-test/d@2.0.0_@aspect-test+c@1.0.0": ["@aspect-test/d"]}
    ...
    closure = gather_transitive_closure(TEST_PACKAGES, TEST_SNAPSHOTS, "@aspect-test/a@5.0.0", no_optional)
    expected = {"@aspect-test/a@5.0.0": ["@aspect-test/a"], "@aspect-test/b@5.0.0": ["@aspect-test/b"], "@aspect-test/c@1.0.0": ["@aspect-test/c"], "@aspect-test/d@2.0.0_@aspect-test+c@1.0.0": ["@aspect-test/d"]}
    asserts.equals(env, expected, closure)
