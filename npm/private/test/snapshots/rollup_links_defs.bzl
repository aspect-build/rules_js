...
def npm_imported_package_store():
    _npm_imported_package_store(
        ...
        deps = {
            ":.aspect_rules_js/fsevents@2.3.2/pkg": "fsevents",
            ":.aspect_rules_js/rollup@2.70.2/pkg": "rollup",
        },
        ref_deps = {
            ":.aspect_rules_js/fsevents@2.3.2/ref": "fsevents",
        },
        lc_deps = {
            ":.aspect_rules_js/fsevents@2.3.2/pkg": "fsevents",
            ":.aspect_rules_js/rollup@2.70.2/pkg_pre_lc_lite": "rollup",
        },
        dev = True,
