...
load("@@_main~npm~npm__helper-date__https___codeload.github.com_coda_helper-date_tar.gz_a2cb4284148cbba7d36173dff4c7c60ce59eae55__links//:defs.bzl", link_607 = "npm_link_imported_package_store", store_607 = "npm_imported_package_store")
load("@@_main~npm~npm__hot-shots__10.0.0__links//:defs.bzl", link_608 = "npm_link_imported_package_store", store_608 = "npm_imported_package_store")
load("@@_main~npm~npm__hpagent__1.2.0__links//:defs.bzl", store_609 = "npm_imported_package_store")
load("@@_main~npm~npm__hsluv__0.0.3__links//:defs.bzl", store_610 = "npm_imported_package_store")
load("@@_main~npm~npm__html-escaper__2.0.2__links//:defs.bzl", store_611 = "npm_imported_package_store")
load("@@_main~npm~npm__http-cache-semantics__4.2.0__links//:defs.bzl", store_612 = "npm_imported_package_store")
load("@@_main~npm~npm__http-errors__2.0.0__links//:defs.bzl", store_613 = "npm_imported_package_store")
load("@@_main~npm~npm__http-proxy-agent__5.0.0__links//:defs.bzl", store_614 = "npm_imported_package_store")
load("@@_main~npm~npm__http-signature__1.2.0__links//:defs.bzl", store_615 = "npm_imported_package_store")
load("@@_main~npm~npm__https-proxy-agent__5.0.1__links//:defs.bzl", store_616 = "npm_imported_package_store")
load("@@_main~npm~npm__humanize-ms__1.2.1__links//:defs.bzl", store_617 = "npm_imported_package_store")
load("@@_main~npm~npm__iconv-lite__0.4.24__links//:defs.bzl", store_618 = "npm_imported_package_store")
load("@@_main~npm~npm__iconv-lite__0.6.3__links//:defs.bzl", store_619 = "npm_imported_package_store")
load("@@_main~npm~npm__icss-utils__5.1.0_postcss_8.5.6__links//:defs.bzl", store_620 = "npm_imported_package_store")
load("@@_main~npm~npm__ieee754__1.2.1__links//:defs.bzl", store_621 = "npm_imported_package_store")
load("@@_main~npm~npm__ignore-walk__3.0.4__links//:defs.bzl", store_622 = "npm_imported_package_store")
load("@@_main~npm~npm__import-fresh__3.3.1__links//:defs.bzl", store_623 = "npm_imported_package_store")
load("@@_main~npm~npm__import-local__3.2.0__links//:defs.bzl", store_624 = "npm_imported_package_store")
load("@@_main~npm~npm__imurmurhash__0.1.4__links//:defs.bzl", store_625 = "npm_imported_package_store")
load("@@_main~npm~npm__indent-string__4.0.0__links//:defs.bzl", store_626 = "npm_imported_package_store")
load("@@_main~npm~npm__infer-owner__1.0.4__links//:defs.bzl", store_627 = "npm_imported_package_store")
load("@@_main~npm~npm__inflight__1.0.6__links//:defs.bzl", store_628 = "npm_imported_package_store")
load("@@_main~npm~npm__inherits__2.0.4__links//:defs.bzl", store_629 = "npm_imported_package_store")
load("@@_main~npm~npm__ini__1.3.8__links//:defs.bzl", store_630 = "npm_imported_package_store")
load("@@_main~npm~npm__inline-fixtures__1.1.0__links//:defs.bzl", link_631 = "npm_link_imported_package_store", store_631 = "npm_imported_package_store")
load("@@_main~npm~npm__inline-fixtures__https___registry.yarnpkg.com_inline-fixtures_-_inline-fixtures-1.1.0.tgz_5f9edf644ac02a1322012dbbb9f0a4739831d662__links//:defs.bzl", link_632 = "npm_link_imported_package_store", store_632 = "npm_imported_package_store")
load("@@_main~npm~npm__interpret__3.1.1__links//:defs.bzl", store_633 = "npm_imported_package_store")
load("@@_main~npm~npm__ip-address__10.0.1__links//:defs.bzl", store_634 = "npm_imported_package_store")
load("@@_main~npm~npm__is-arrayish__0.2.1__links//:defs.bzl", store_635 = "npm_imported_package_store")
load("@@_main~npm~npm__is-arrayish__0.3.4__links//:defs.bzl", store_636 = "npm_imported_package_store")
load("@@_main~npm~npm__is-binary-path__2.1.0__links//:defs.bzl", store_637 = "npm_imported_package_store")
load("@@_main~npm~npm__is-browser__2.1.0__links//:defs.bzl", store_638 = "npm_imported_package_store")
load("@@_main~npm~npm__is-buffer__1.1.6__links//:defs.bzl", store_639 = "npm_imported_package_store")
load("@@_main~npm~npm__is-callable__1.2.7__links//:defs.bzl", store_640 = "npm_imported_package_store")
load("@@_main~npm~npm__is-core-module__2.16.1__links//:defs.bzl", store_641 = "npm_imported_package_store")
load("@@_main~npm~npm__is-extglob__2.1.1__links//:defs.bzl", store_642 = "npm_imported_package_store")
load("@@_main~npm~npm__is-finite__1.1.0__links//:defs.bzl", store_643 = "npm_imported_package_store")
load("@@_main~npm~npm__is-firefox__1.0.3__links//:defs.bzl", store_644 = "npm_imported_package_store")
load("@@_main~npm~npm__is-fullwidth-code-point__1.0.0__links//:defs.bzl", store_645 = "npm_imported_package_store")
load("@@_main~npm~npm__is-fullwidth-code-point__3.0.0__links//:defs.bzl", store_646 = "npm_imported_package_store")
load("@@_main~npm~npm__is-glob__4.0.3__links//:defs.bzl", store_647 = "npm_imported_package_store")
load("@@_main~npm~npm__is-iexplorer__1.0.0__links//:defs.bzl", store_648 = "npm_imported_package_store")
load("@@_main~npm~npm__is-lambda__1.0.1__links//:defs.bzl", store_649 = "npm_imported_package_store")
load("@@_main~npm~npm__is-mobile__4.0.0__links//:defs.bzl", store_650 = "npm_imported_package_store")
load("@@_main~npm~npm__is-module__1.0.0__links//:defs.bzl", store_651 = "npm_imported_package_store")
load("@@_main~npm~npm__is-number__6.0.0__links//:defs.bzl", store_652 = "npm_imported_package_store")
load("@@_main~npm~npm__is-number__7.0.0__links//:defs.bzl", store_653 = "npm_imported_package_store")
load("@@_main~npm~npm__is-obj__1.0.1__links//:defs.bzl", store_654 = "npm_imported_package_store")
load("@@_main~npm~npm__is-plain-obj__1.1.0__links//:defs.bzl", store_655 = "npm_imported_package_store")
load("@@_main~npm~npm__is-plain-obj__2.1.0__links//:defs.bzl", store_656 = "npm_imported_package_store")
load("@@_main~npm~npm__is-plain-object__2.0.4__links//:defs.bzl", store_657 = "npm_imported_package_store")
load("@@_main~npm~npm__is-reference__1.2.1__links//:defs.bzl", store_658 = "npm_imported_package_store")
load("@@_main~npm~npm__is-string-blank__1.0.1__links//:defs.bzl", store_659 = "npm_imported_package_store")
load("@@_main~npm~npm__is-svg-path__1.0.2__links//:defs.bzl", store_660 = "npm_imported_package_store")
load("@@_main~npm~npm__is-typed-array__1.1.15__links//:defs.bzl", store_661 = "npm_imported_package_store")
load("@@_main~npm~npm__is-typedarray__1.0.0__links//:defs.bzl", store_662 = "npm_imported_package_store")
load("@@_main~npm~npm__is-unicode-supported__0.1.0__links//:defs.bzl", store_663 = "npm_imported_package_store")
load("@@_main~npm~npm__isarray__0.0.1__links//:defs.bzl", store_664 = "npm_imported_package_store")
load("@@_main~npm~npm__isarray__1.0.0__links//:defs.bzl", store_665 = "npm_imported_package_store")
load("@@_main~npm~npm__isarray__2.0.5__links//:defs.bzl", store_666 = "npm_imported_package_store")
load("@@_main~npm~npm__isexe__2.0.0__links//:defs.bzl", store_667 = "npm_imported_package_store")
load("@@_main~npm~npm__isobject__3.0.1__links//:defs.bzl", store_668 = "npm_imported_package_store")
load("@@_main~npm~npm__isomorphic-ws__5.0.0_ws_8.18.3_bufferutil_4.0.8__links//:defs.bzl", store_669 = "npm_imported_package_store")
load("@@_main~npm~npm__isstream__0.1.2__links//:defs.bzl", store_670 = "npm_imported_package_store")
load("@@_main~npm~npm__istanbul-lib-coverage__3.2.2__links//:defs.bzl", store_671 = "npm_imported_package_store")
load("@@_main~npm~npm__istanbul-lib-report__3.0.1__links//:defs.bzl", store_672 = "npm_imported_package_store")
load("@@_main~npm~npm__istanbul-reports__3.2.0__links//:defs.bzl", store_673 = "npm_imported_package_store")
load("@@_main~npm~npm__jackspeak__3.4.3__links//:defs.bzl", store_674 = "npm_imported_package_store")
load("@@_main~npm~npm__jasmine-core__5.1.2__links//:defs.bzl", store_675 = "npm_imported_package_store")
load("@@_main~npm~npm__jasmine__5.1.0__links//:defs.bzl", link_676 = "npm_link_imported_package_store", store_676 = "npm_imported_package_store")
load("@@_main~npm~npm__javascript-natural-sort__0.7.1__links//:defs.bzl", store_677 = "npm_imported_package_store")
load("@@_main~npm~npm__javascript-stringify__2.1.0__links//:defs.bzl", store_678 = "npm_imported_package_store")
load("@@_main~npm~npm__jest-worker__27.5.1__links//:defs.bzl", store_679 = "npm_imported_package_store")
load("@@_main~npm~npm__jiti__2.6.1__links//:defs.bzl", store_680 = "npm_imported_package_store")
load("@@_main~npm~npm__jose__6.1.0__links//:defs.bzl", store_681 = "npm_imported_package_store")
load("@@_main~npm~npm__js-tokens__4.0.0__links//:defs.bzl", store_682 = "npm_imported_package_store")
load("@@_main~npm~npm__js-yaml__4.1.0__links//:defs.bzl", store_683 = "npm_imported_package_store")
load("@@_main~npm~npm__jsbn__0.1.1__links//:defs.bzl", store_684 = "npm_imported_package_store")
load("@@_main~npm~npm__jsep__1.4.0__links//:defs.bzl", store_685 = "npm_imported_package_store")
load("@@_main~npm~npm__jsesc__3.1.0__links//:defs.bzl", store_686 = "npm_imported_package_store")
load("@@_main~npm~npm__json-buffer__3.0.1__links//:defs.bzl", store_687 = "npm_imported_package_store")
load("@@_main~npm~npm__json-parse-even-better-errors__2.3.1__links//:defs.bzl", store_688 = "npm_imported_package_store")
load("@@_main~npm~npm__json-schema-traverse__0.4.1__links//:defs.bzl", store_689 = "npm_imported_package_store")
load("@@_main~npm~npm__json-schema-traverse__1.0.0__links//:defs.bzl", store_690 = "npm_imported_package_store")
load("@@_main~npm~npm__json-schema__0.4.0__links//:defs.bzl", store_691 = "npm_imported_package_store")
load("@@_main~npm~npm__json-stable-stringify__1.0.1__links//:defs.bzl", link_692 = "npm_link_imported_package_store", store_692 = "npm_imported_package_store")
load("@@_main~npm~npm__json-stringify-safe__5.0.1__links//:defs.bzl", store_693 = "npm_imported_package_store")
load("@@_main~npm~npm__json5__2.2.3__links//:defs.bzl", store_694 = "npm_imported_package_store")
load("@@_main~npm~npm__jsonfile__4.0.0__links//:defs.bzl", store_695 = "npm_imported_package_store")
load("@@_main~npm~npm__jsonfile__6.2.0__links//:defs.bzl", store_696 = "npm_imported_package_store")
load("@@_main~npm~npm__jsonpath-plus__10.3.0__links//:defs.bzl", store_697 = "npm_imported_package_store")
load("@@_main~npm~npm__jsonpath-plus__7.2.0__links//:defs.bzl", link_698 = "npm_link_imported_package_store", store_698 = "npm_imported_package_store")
load("@@_main~npm~npm__jsprim__1.4.2__links//:defs.bzl", store_699 = "npm_imported_package_store")
load("@@_main~npm~npm__kdbush__3.0.0__links//:defs.bzl", store_700 = "npm_imported_package_store")
load("@@_main~npm~npm__keyv__4.5.4__links//:defs.bzl", store_701 = "npm_imported_package_store")
load("@@_main~npm~npm__kind-of__3.2.2__links//:defs.bzl", store_702 = "npm_imported_package_store")
load("@@_main~npm~npm__kind-of__6.0.3__links//:defs.bzl", store_703 = "npm_imported_package_store")
load("@@_main~npm~npm__kleur__4.1.5__links//:defs.bzl", store_704 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-android-arm64__1.30.2__links//:defs.bzl", store_705 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-darwin-arm64__1.29.2__links//:defs.bzl", store_706 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-darwin-arm64__1.30.2__links//:defs.bzl", store_707 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-darwin-x64__1.29.2__links//:defs.bzl", store_708 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-darwin-x64__1.30.2__links//:defs.bzl", store_709 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-freebsd-x64__1.29.2__links//:defs.bzl", store_710 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-freebsd-x64__1.30.2__links//:defs.bzl", store_711 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-arm-gnueabihf__1.29.2__links//:defs.bzl", store_712 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-arm-gnueabihf__1.30.2__links//:defs.bzl", store_713 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-arm64-gnu__1.29.2__links//:defs.bzl", store_714 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-arm64-gnu__1.30.2__links//:defs.bzl", store_715 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-arm64-musl__1.29.2__links//:defs.bzl", store_716 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-arm64-musl__1.30.2__links//:defs.bzl", store_717 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-x64-gnu__1.29.2__links//:defs.bzl", store_718 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-x64-gnu__1.30.2__links//:defs.bzl", store_719 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-x64-musl__1.29.2__links//:defs.bzl", store_720 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-linux-x64-musl__1.30.2__links//:defs.bzl", store_721 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-win32-arm64-msvc__1.29.2__links//:defs.bzl", store_722 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-win32-arm64-msvc__1.30.2__links//:defs.bzl", store_723 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-win32-x64-msvc__1.29.2__links//:defs.bzl", store_724 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss-win32-x64-msvc__1.30.2__links//:defs.bzl", store_725 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss__1.29.2__links//:defs.bzl", store_726 = "npm_imported_package_store")
load("@@_main~npm~npm__lightningcss__1.30.2__links//:defs.bzl", store_727 = "npm_imported_package_store")
load("@@_main~npm~npm__lines-and-columns__1.2.4__links//:defs.bzl", store_728 = "npm_imported_package_store")
load("@@_main~npm~npm__loader-runner__4.3.1__links//:defs.bzl", store_729 = "npm_imported_package_store")
load("@@_main~npm~npm__loader-utils__2.0.4__links//:defs.bzl", store_730 = "npm_imported_package_store")
load("@@_main~npm~npm__locate-path__5.0.0__links//:defs.bzl", store_731 = "npm_imported_package_store")
load("@@_main~npm~npm__locate-path__6.0.0__links//:defs.bzl", store_732 = "npm_imported_package_store")
load("@@_main~npm~npm__lodash.merge__4.6.2__links//:defs.bzl", store_733 = "npm_imported_package_store")
load("@@_main~npm~npm__lodash__4.17.21__links//:defs.bzl", store_734 = "npm_imported_package_store")
load("@@_main~npm~npm__lodash__file_npm_private_test_vendored_lodash-4.17.21.tgz__links//:defs.bzl", link_735 = "npm_link_imported_package_store", store_735 = "npm_imported_package_store")
load("@@_main~npm~npm__log-symbols__4.1.0__links//:defs.bzl", store_736 = "npm_imported_package_store")
load("@@_main~npm~npm__loose-envify__1.4.0__links//:defs.bzl", store_737 = "npm_imported_package_store")
load("@@_main~npm~npm__lowercase-keys__2.0.0__links//:defs.bzl", store_738 = "npm_imported_package_store")
load("@@_main~npm~npm__lru-cache__10.4.3__links//:defs.bzl", store_739 = "npm_imported_package_store")
load("@@_main~npm~npm__lru-cache__5.1.1__links//:defs.bzl", store_740 = "npm_imported_package_store")
load("@@_main~npm~npm__lru-cache__6.0.0__links//:defs.bzl", store_741 = "npm_imported_package_store")
load("@@_main~npm~npm__lru-cache__7.18.3__links//:defs.bzl", store_742 = "npm_imported_package_store")
load("@@_main~npm~npm__magic-string__0.25.9__links//:defs.bzl", store_743 = "npm_imported_package_store")
load("@@_main~npm~npm__magic-string__0.30.21__links//:defs.bzl", store_744 = "npm_imported_package_store")
load("@@_main~npm~npm__make-dir__2.1.0__links//:defs.bzl", store_745 = "npm_imported_package_store")
load("@@_main~npm~npm__make-dir__4.0.0__links//:defs.bzl", store_746 = "npm_imported_package_store")
load("@@_main~npm~npm__make-fetch-happen__10.2.1__links//:defs.bzl", store_747 = "npm_imported_package_store")
load("@@_main~npm~npm__map-limit__0.0.1__links//:defs.bzl", store_748 = "npm_imported_package_store")
load("@@_main~npm~npm__mapbox-gl__1.10.1__links//:defs.bzl", store_749 = "npm_imported_package_store")
load("@@_main~npm~npm__math-intrinsics__1.1.0__links//:defs.bzl", store_750 = "npm_imported_package_store")
load("@@_main~npm~npm__math-log2__1.0.1__links//:defs.bzl", store_751 = "npm_imported_package_store")
load("@@_main~npm~npm__mathjs__11.4.0__links//:defs.bzl", link_752 = "npm_link_imported_package_store", store_752 = "npm_imported_package_store")
load("@@_main~npm~npm__md5__2.3.0__links//:defs.bzl", store_753 = "npm_imported_package_store")
load("@@_main~npm~npm__meaning-of-life__1.0.0_o3deharooos255qt5xdujc3cuq__links//:defs.bzl", link_754 = "npm_link_imported_package_store", store_754 = "npm_imported_package_store")
load("@@_main~npm~npm__media-query-parser__2.0.2__links//:defs.bzl", store_755 = "npm_imported_package_store")
load("@@_main~npm~npm__merge-stream__2.0.0__links//:defs.bzl", store_756 = "npm_imported_package_store")
load("@@_main~npm~npm__mime-db__1.52.0__links//:defs.bzl", store_757 = "npm_imported_package_store")
load("@@_main~npm~npm__mime-types__2.1.35__links//:defs.bzl", store_758 = "npm_imported_package_store")
load("@@_main~npm~npm__mime__3.0.0__links//:defs.bzl", store_759 = "npm_imported_package_store")
load("@@_main~npm~npm__mimic-response__1.0.1__links//:defs.bzl", store_760 = "npm_imported_package_store")
load("@@_main~npm~npm__mimic-response__2.1.0__links//:defs.bzl", store_761 = "npm_imported_package_store")
load("@@_main~npm~npm__mini-css-extract-plugin__2.7.5_webpack_5.76.3__links//:defs.bzl", link_762 = "npm_link_imported_package_store", store_762 = "npm_imported_package_store")
load("@@_main~npm~npm__minimatch__3.1.2__links//:defs.bzl", store_763 = "npm_imported_package_store")
load("@@_main~npm~npm__minimatch__5.0.1__links//:defs.bzl", store_764 = "npm_imported_package_store")
load("@@_main~npm~npm__minimatch__5.1.6__links//:defs.bzl", store_765 = "npm_imported_package_store")
load("@@_main~npm~npm__minimatch__6.2.0__links//:defs.bzl", store_766 = "npm_imported_package_store")
load("@@_main~npm~npm__minimatch__9.0.5__links//:defs.bzl", store_767 = "npm_imported_package_store")
load("@@_main~npm~npm__minimist__0.0.10__links//:defs.bzl", store_768 = "npm_imported_package_store")
load("@@_main~npm~npm__minimist__1.2.8__links//:defs.bzl", store_769 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass-collect__1.0.2__links//:defs.bzl", store_770 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass-fetch__2.1.2__links//:defs.bzl", store_771 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass-flush__1.0.5__links//:defs.bzl", store_772 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass-pipeline__1.2.4__links//:defs.bzl", store_773 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass-sized__1.0.3__links//:defs.bzl", store_774 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass__2.9.0__links//:defs.bzl", store_775 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass__3.3.6__links//:defs.bzl", store_776 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass__4.2.8__links//:defs.bzl", store_777 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass__5.0.0__links//:defs.bzl", store_778 = "npm_imported_package_store")
load("@@_main~npm~npm__minipass__7.1.2__links//:defs.bzl", store_779 = "npm_imported_package_store")
load("@@_main~npm~npm__minizlib__1.3.3__links//:defs.bzl", store_780 = "npm_imported_package_store")
load("@@_main~npm~npm__minizlib__2.1.2__links//:defs.bzl", store_781 = "npm_imported_package_store")
load("@@_main~npm~npm__minizlib__3.1.0__links//:defs.bzl", store_782 = "npm_imported_package_store")
load("@@_main~npm~npm__mitt__3.0.0__links//:defs.bzl", store_783 = "npm_imported_package_store")
load("@@_main~npm~npm__mkdirp-classic__0.5.3__links//:defs.bzl", store_784 = "npm_imported_package_store")
load("@@_main~npm~npm__mkdirp__0.5.6__links//:defs.bzl", store_785 = "npm_imported_package_store")
load("@@_main~npm~npm__mkdirp__1.0.4__links//:defs.bzl", store_786 = "npm_imported_package_store")
load("@@_main~npm~npm__mlly__1.8.0__links//:defs.bzl", store_787 = "npm_imported_package_store")
load("@@_main~npm~npm__mobx-react-lite__3.4.3_mobx_6.3.0_react_17.0.2__links//:defs.bzl", store_788 = "npm_imported_package_store")
load("@@_main~npm~npm__mobx-react__7.3.0_mobx_6.3.0_react_17.0.2__links//:defs.bzl", link_789 = "npm_link_imported_package_store", store_789 = "npm_imported_package_store")
load("@@_main~npm~npm__mobx__6.3.0__links//:defs.bzl", link_790 = "npm_link_imported_package_store", store_790 = "npm_imported_package_store")
load("@@_main~npm~npm__mocha-junit-reporter__2.2.0_mocha_10.2.0__links//:defs.bzl", link_791 = "npm_link_imported_package_store", store_791 = "npm_imported_package_store")
load("@@_main~npm~npm__mocha-multi-reporters__1.5.1_181752652__links//:defs.bzl", link_792 = "npm_link_imported_package_store", store_792 = "npm_imported_package_store")
load("@@_main~npm~npm__mocha__10.2.0_mocha-multi-reporters_1.5.1__links//:defs.bzl", link_793 = "npm_link_imported_package_store", store_793 = "npm_imported_package_store")
load("@@_main~npm~npm__modern-ahocorasick__1.1.0__links//:defs.bzl", store_794 = "npm_imported_package_store")
load("@@_main~npm~npm__moment-timezone__0.5.48__links//:defs.bzl", store_795 = "npm_imported_package_store")
load("@@_main~npm~npm__moment__2.30.1__links//:defs.bzl", store_796 = "npm_imported_package_store")
load("@@_main~npm~npm__mouse-change__1.4.0__links//:defs.bzl", store_797 = "npm_imported_package_store")
load("@@_main~npm~npm__mouse-event-offset__3.0.2__links//:defs.bzl", store_798 = "npm_imported_package_store")
load("@@_main~npm~npm__mouse-event__1.0.5__links//:defs.bzl", store_799 = "npm_imported_package_store")
load("@@_main~npm~npm__mouse-wheel__1.2.0__links//:defs.bzl", store_800 = "npm_imported_package_store")
load("@@_main~npm~npm__mri__1.2.0__links//:defs.bzl", store_801 = "npm_imported_package_store")
load("@@_main~npm~npm__mrmime__1.0.1__links//:defs.bzl", store_802 = "npm_imported_package_store")
load("@@_main~npm~npm__ms__0.7.2__links//:defs.bzl", store_803 = "npm_imported_package_store")
load("@@_main~npm~npm__ms__0.7.3__links//:defs.bzl", store_804 = "npm_imported_package_store")
load("@@_main~npm~npm__ms__2.0.0__links//:defs.bzl", store_805 = "npm_imported_package_store")
load("@@_main~npm~npm__ms__2.1.2__links//:defs.bzl", store_806 = "npm_imported_package_store")
load("@@_main~npm~npm__ms__2.1.3__links//:defs.bzl", link_807 = "npm_link_imported_package_store", store_807 = "npm_imported_package_store")
load("@@_main~npm~npm__mumath__3.3.4__links//:defs.bzl", store_808 = "npm_imported_package_store")
load("@@_main~npm~npm__murmurhash-js__1.0.0__links//:defs.bzl", store_809 = "npm_imported_package_store")
load("@@_main~npm~npm__nan__2.23.0__links//:defs.bzl", store_810 = "npm_imported_package_store")
load("@@_main~npm~npm__nanoid__3.3.11__links//:defs.bzl", store_811 = "npm_imported_package_store")
load("@@_main~npm~npm__nanoid__3.3.3__links//:defs.bzl", store_812 = "npm_imported_package_store")
load("@@_main~npm~npm__native-promise-only__0.8.1__links//:defs.bzl", store_813 = "npm_imported_package_store")
load("@@_main~npm~npm__needle__2.9.1__links//:defs.bzl", store_814 = "npm_imported_package_store")
load("@@_main~npm~npm__negotiator__0.6.4__links//:defs.bzl", store_815 = "npm_imported_package_store")
load("@@_main~npm~npm__neo-async__2.6.2__links//:defs.bzl", store_816 = "npm_imported_package_store")
load("@@_main~npm~npm__next-tick__1.1.0__links//:defs.bzl", store_817 = "npm_imported_package_store")
load("@@_main~npm~npm__next__15.2.4_1790925128__links//:defs.bzl", link_818 = "npm_link_imported_package_store", store_818 = "npm_imported_package_store")
load("@@_main~npm~npm__node-fetch__2.6.7_encoding_0.1.13__links//:defs.bzl", store_819 = "npm_imported_package_store")
load("@@_main~npm~npm__node-fetch__2.7.0_encoding_0.1.13__links//:defs.bzl", store_820 = "npm_imported_package_store")
load("@@_main~npm~npm__node-gyp-build__4.8.4__links//:defs.bzl", store_821 = "npm_imported_package_store")
load("@@_main~npm~npm__node-gyp__7.1.2__links//:defs.bzl", store_822 = "npm_imported_package_store")
load("@@_main~npm~npm__node-gyp__9.3.0__links//:defs.bzl", link_823 = "npm_link_imported_package_store", store_823 = "npm_imported_package_store")
load("@@_main~npm~npm__node-pre-gyp__0.13.0__links//:defs.bzl", store_824 = "npm_imported_package_store")
load("@@_main~npm~npm__node-releases__2.0.27__links//:defs.bzl", store_825 = "npm_imported_package_store")
load("@@_main~npm~npm__nopt__4.0.3__links//:defs.bzl", store_826 = "npm_imported_package_store")
load("@@_main~npm~npm__nopt__5.0.0__links//:defs.bzl", store_827 = "npm_imported_package_store")
load("@@_main~npm~npm__nopt__6.0.0__links//:defs.bzl", store_828 = "npm_imported_package_store")
load("@@_main~npm~npm__normalize-path__3.0.0__links//:defs.bzl", store_829 = "npm_imported_package_store")
load("@@_main~npm~npm__normalize-svg-path__0.1.0__links//:defs.bzl", store_830 = "npm_imported_package_store")
load("@@_main~npm~npm__normalize-svg-path__1.1.0__links//:defs.bzl", store_831 = "npm_imported_package_store")
load("@@_main~npm~npm__normalize-url__6.1.0__links//:defs.bzl", store_832 = "npm_imported_package_store")
load("@@_main~npm~npm__npm-bundled__1.1.2__links//:defs.bzl", store_833 = "npm_imported_package_store")
load("@@_main~npm~npm__npm-normalize-package-bin__1.0.1__links//:defs.bzl", store_834 = "npm_imported_package_store")
load("@@_main~npm~npm__npm-packlist__1.4.8__links//:defs.bzl", store_835 = "npm_imported_package_store")
load("@@_main~npm~npm__npmlog__4.1.2__links//:defs.bzl", store_836 = "npm_imported_package_store")
load("@@_main~npm~npm__npmlog__6.0.2__links//:defs.bzl", store_837 = "npm_imported_package_store")
load("@@_main~npm~npm__number-is-integer__1.0.1__links//:defs.bzl", store_838 = "npm_imported_package_store")
load("@@_main~npm~npm__number-is-nan__1.0.1__links//:defs.bzl", store_839 = "npm_imported_package_store")
load("@@_main~npm~npm__oauth-sign__0.9.0__links//:defs.bzl", store_840 = "npm_imported_package_store")
load("@@_main~npm~npm__oauth4webapi__3.8.2__links//:defs.bzl", store_841 = "npm_imported_package_store")
load("@@_main~npm~npm__object-assign__4.1.1__links//:defs.bzl", store_842 = "npm_imported_package_store")
load("@@_main~npm~npm__once__1.3.3__links//:defs.bzl", store_843 = "npm_imported_package_store")
load("@@_main~npm~npm__once__1.4.0__links//:defs.bzl", store_844 = "npm_imported_package_store")
load("@@_main~npm~npm__opener__1.5.2__links//:defs.bzl", store_845 = "npm_imported_package_store")
load("@@_main~npm~npm__openid-client__6.8.1__links//:defs.bzl", store_846 = "npm_imported_package_store")
load("@@_main~npm~npm__optimist__0.6.0__links//:defs.bzl", store_847 = "npm_imported_package_store")
load("@@_main~npm~npm__os-homedir__1.0.2__links//:defs.bzl", store_848 = "npm_imported_package_store")
load("@@_main~npm~npm__os-tmpdir__1.0.2__links//:defs.bzl", store_849 = "npm_imported_package_store")
load("@@_main~npm~npm__osenv__0.1.5__links//:defs.bzl", store_850 = "npm_imported_package_store")
load("@@_main~npm~npm__outdent__0.8.0__links//:defs.bzl", store_851 = "npm_imported_package_store")
load("@@_main~npm~npm__p-cancelable__2.1.1__links//:defs.bzl", store_852 = "npm_imported_package_store")
load("@@_main~npm~npm__p-event__4.2.0__links//:defs.bzl", store_853 = "npm_imported_package_store")
load("@@_main~npm~npm__p-finally__1.0.0__links//:defs.bzl", store_854 = "npm_imported_package_store")
load("@@_main~npm~npm__p-limit__2.3.0__links//:defs.bzl", store_855 = "npm_imported_package_store")
load("@@_main~npm~npm__p-limit__3.1.0__links//:defs.bzl", store_856 = "npm_imported_package_store")
load("@@_main~npm~npm__p-locate__4.1.0__links//:defs.bzl", store_857 = "npm_imported_package_store")
load("@@_main~npm~npm__p-locate__5.0.0__links//:defs.bzl", store_858 = "npm_imported_package_store")
load("@@_main~npm~npm__p-map__4.0.0__links//:defs.bzl", store_859 = "npm_imported_package_store")
load("@@_main~npm~npm__p-timeout__3.2.0__links//:defs.bzl", store_860 = "npm_imported_package_store")
load("@@_main~npm~npm__p-try__2.2.0__links//:defs.bzl", store_861 = "npm_imported_package_store")
load("@@_main~npm~npm__package-json-from-dist__1.0.1__links//:defs.bzl", store_862 = "npm_imported_package_store")
load("@@_main~npm~npm__parent-module__1.0.1__links//:defs.bzl", store_863 = "npm_imported_package_store")
load("@@_main~npm~npm__parenthesis__3.1.8__links//:defs.bzl", store_864 = "npm_imported_package_store")
load("@@_main~npm~npm__parse-json__5.2.0__links//:defs.bzl", store_865 = "npm_imported_package_store")
load("@@_main~npm~npm__parse-rect__1.2.0__links//:defs.bzl", store_866 = "npm_imported_package_store")
load("@@_main~npm~npm__parse-svg-path__0.1.2__links//:defs.bzl", store_867 = "npm_imported_package_store")
load("@@_main~npm~npm__parse-unit__1.0.1__links//:defs.bzl", store_868 = "npm_imported_package_store")
load("@@_main~npm~npm__path-exists__4.0.0__links//:defs.bzl", store_869 = "npm_imported_package_store")
load("@@_main~npm~npm__path-is-absolute__1.0.1__links//:defs.bzl", store_870 = "npm_imported_package_store")
load("@@_main~npm~npm__path-key__3.1.1__links//:defs.bzl", store_871 = "npm_imported_package_store")
load("@@_main~npm~npm__path-parse__1.0.7__links//:defs.bzl", store_872 = "npm_imported_package_store")
load("@@_main~npm~npm__path-scurry__1.11.1__links//:defs.bzl", store_873 = "npm_imported_package_store")
load("@@_main~npm~npm__path-type__4.0.0__links//:defs.bzl", store_874 = "npm_imported_package_store")
load("@@_main~npm~npm__pathe__1.1.2__links//:defs.bzl", store_875 = "npm_imported_package_store")
load("@@_main~npm~npm__pathe__2.0.3__links//:defs.bzl", store_876 = "npm_imported_package_store")
load("@@_main~npm~npm__pbf__3.3.0__links//:defs.bzl", store_877 = "npm_imported_package_store")
load("@@_main~npm~npm__pend__1.2.0__links//:defs.bzl", store_878 = "npm_imported_package_store")
load("@@_main~npm~npm__performance-now__2.1.0__links//:defs.bzl", store_879 = "npm_imported_package_store")
load("@@_main~npm~npm__pick-by-alias__1.2.0__links//:defs.bzl", store_880 = "npm_imported_package_store")
load("@@_main~npm~npm__picocolors__1.1.1__links//:defs.bzl", store_881 = "npm_imported_package_store")
load("@@_main~npm~npm__picomatch__2.3.1__links//:defs.bzl", store_882 = "npm_imported_package_store")
load("@@_main~npm~npm__picomatch__4.0.3__links//:defs.bzl", store_883 = "npm_imported_package_store")
load("@@_main~npm~npm__pify__4.0.1__links//:defs.bzl", store_884 = "npm_imported_package_store")
load("@@_main~npm~npm__pkg-dir__4.2.0__links//:defs.bzl", store_885 = "npm_imported_package_store")
load("@@_main~npm~npm__pkg-types__1.3.1__links//:defs.bzl", store_886 = "npm_imported_package_store")
load("@@_main~npm~npm__plotly.js__2.25.2__links//:defs.bzl", link_887 = "npm_link_imported_package_store", store_887 = "npm_imported_package_store")
load("@@_main~npm~npm__pngjs__5.0.0__links//:defs.bzl", link_888 = "npm_link_imported_package_store", store_888 = "npm_imported_package_store")
load("@@_main~npm~npm__point-in-polygon__1.1.0__links//:defs.bzl", store_889 = "npm_imported_package_store")
load("@@_main~npm~npm__polybooljs__1.2.2__links//:defs.bzl", store_890 = "npm_imported_package_store")
load("@@_main~npm~npm__possible-typed-array-names__1.1.0__links//:defs.bzl", store_891 = "npm_imported_package_store")
load("@@_main~npm~npm__postcss-modules-extract-imports__3.1.0_postcss_8.5.6__links//:defs.bzl", store_892 = "npm_imported_package_store")
load("@@_main~npm~npm__postcss-modules-local-by-default__4.2.0_postcss_8.5.6__links//:defs.bzl", store_893 = "npm_imported_package_store")
load("@@_main~npm~npm__postcss-modules-scope__3.2.1_postcss_8.5.6__links//:defs.bzl", store_894 = "npm_imported_package_store")
load("@@_main~npm~npm__postcss-modules-values__4.0.0_postcss_8.5.6__links//:defs.bzl", store_895 = "npm_imported_package_store")
load("@@_main~npm~npm__postcss-selector-parser__7.1.0__links//:defs.bzl", store_896 = "npm_imported_package_store")
load("@@_main~npm~npm__postcss-value-parser__4.2.0__links//:defs.bzl", store_897 = "npm_imported_package_store")
load("@@_main~npm~npm__postcss__8.4.31__links//:defs.bzl", store_898 = "npm_imported_package_store")
load("@@_main~npm~npm__postcss__8.5.6__links//:defs.bzl", store_899 = "npm_imported_package_store")
load("@@_main~npm~npm__potpack__1.0.2__links//:defs.bzl", store_900 = "npm_imported_package_store")
load("@@_main~npm~npm__probe-image-size__7.2.3__links//:defs.bzl", store_901 = "npm_imported_package_store")
load("@@_main~npm~npm__process-nextick-args__2.0.1__links//:defs.bzl", store_902 = "npm_imported_package_store")
load("@@_main~npm~npm__progress__2.0.3__links//:defs.bzl", store_903 = "npm_imported_package_store")
load("@@_main~npm~npm__promise-inflight__1.0.1__links//:defs.bzl", store_904 = "npm_imported_package_store")
load("@@_main~npm~npm__promise-retry__2.0.1__links//:defs.bzl", store_905 = "npm_imported_package_store")
load("@@_main~npm~npm__protoc-gen-grpc__https___codeload.github.com_gregmagolan-codaio_protoc-gen-grpc-ts_tar.gz_be5580b06348d3eb9b4610a4a94065154a0df41f__links//:defs.bzl", link_906 = "npm_link_imported_package_store", store_906 = "npm_imported_package_store")
load("@@_main~npm~npm__protocol-buffers-schema__3.6.0__links//:defs.bzl", store_907 = "npm_imported_package_store")
load("@@_main~npm~npm__proxy-from-env__1.1.0__links//:defs.bzl", store_908 = "npm_imported_package_store")
load("@@_main~npm~npm__psl__1.15.0__links//:defs.bzl", store_909 = "npm_imported_package_store")
load("@@_main~npm~npm__pump__1.0.3__links//:defs.bzl", store_910 = "npm_imported_package_store")
load("@@_main~npm~npm__pump__3.0.3__links//:defs.bzl", store_911 = "npm_imported_package_store")
load("@@_main~npm~npm__punycode__2.3.1__links//:defs.bzl", store_912 = "npm_imported_package_store")
load("@@_main~npm~npm__puppeteer-core__19.11.1_230959327__links//:defs.bzl", store_913 = "npm_imported_package_store")
load("@@_main~npm~npm__puppeteer__19.11.1_230959327__links//:defs.bzl", link_914 = "npm_link_imported_package_store", store_914 = "npm_imported_package_store")
load("@@_main~npm~npm__qs__6.5.3__links//:defs.bzl", store_915 = "npm_imported_package_store")
load("@@_main~npm~npm__quickselect__2.0.0__links//:defs.bzl", store_916 = "npm_imported_package_store")
load("@@_main~npm~npm__raf__3.4.1__links//:defs.bzl", store_917 = "npm_imported_package_store")
load("@@_main~npm~npm__ramda__0.25.0__links//:defs.bzl", store_918 = "npm_imported_package_store")
load("@@_main~npm~npm__randombytes__2.1.0__links//:defs.bzl", store_919 = "npm_imported_package_store")
load("@@_main~npm~npm__rc__1.2.8__links//:defs.bzl", store_920 = "npm_imported_package_store")
load("@@_main~npm~npm__react-dom__19.2.0_react_19.2.0__links//:defs.bzl", link_921 = "npm_link_imported_package_store", store_921 = "npm_imported_package_store")
load("@@_main~npm~npm__react__17.0.2__links//:defs.bzl", link_922 = "npm_link_imported_package_store", store_922 = "npm_imported_package_store")
load("@@_main~npm~npm__react__19.2.0__links//:defs.bzl", link_923 = "npm_link_imported_package_store", store_923 = "npm_imported_package_store")
load("@@_main~npm~npm__read-yaml-file__2.1.0__links//:defs.bzl", store_924 = "npm_imported_package_store")
load("@@_main~npm~npm__readable-stream__1.0.34__links//:defs.bzl", store_925 = "npm_imported_package_store")
load("@@_main~npm~npm__readable-stream__2.3.8__links//:defs.bzl", store_926 = "npm_imported_package_store")
load("@@_main~npm~npm__readable-stream__3.6.2__links//:defs.bzl", store_927 = "npm_imported_package_store")
load("@@_main~npm~npm__readdirp__3.6.0__links//:defs.bzl", store_928 = "npm_imported_package_store")
load("@@_main~npm~npm__rechoir__0.8.0__links//:defs.bzl", store_929 = "npm_imported_package_store")
load("@@_main~npm~npm__regl-error2d__2.0.12__links//:defs.bzl", store_930 = "npm_imported_package_store")
load("@@_main~npm~npm__regl-line2d__3.1.3__links//:defs.bzl", store_931 = "npm_imported_package_store")
load("@@_main~npm~npm__regl-scatter2d__3.3.1__links//:defs.bzl", store_932 = "npm_imported_package_store")
load("@@_main~npm~npm__regl-splom__1.0.14__links//:defs.bzl", store_933 = "npm_imported_package_store")
load("@@_main~npm~npm__regl__2.1.1__links//:defs.bzl", store_934 = "npm_imported_package_store")
load("@@_main~npm~npm__request__2.88.2__links//:defs.bzl", store_935 = "npm_imported_package_store")
load("@@_main~npm~npm__require-directory__2.1.1__links//:defs.bzl", store_936 = "npm_imported_package_store")
load("@@_main~npm~npm__require-from-string__2.0.2__links//:defs.bzl", store_937 = "npm_imported_package_store")
load("@@_main~npm~npm__require-like__0.1.2__links//:defs.bzl", store_938 = "npm_imported_package_store")
load("@@_main~npm~npm__resolve-cwd__3.0.0__links//:defs.bzl", store_939 = "npm_imported_package_store")
load("@@_main~npm~npm__resolve-from__4.0.0__links//:defs.bzl", store_940 = "npm_imported_package_store")
load("@@_main~npm~npm__resolve-from__5.0.0__links//:defs.bzl", store_941 = "npm_imported_package_store")
load("@@_main~npm~npm__resolve-protobuf-schema__2.1.0__links//:defs.bzl", store_942 = "npm_imported_package_store")
load("@@_main~npm~npm__resolve__0.6.3__links//:defs.bzl", store_943 = "npm_imported_package_store")
load("@@_main~npm~npm__resolve__1.22.11__links//:defs.bzl", store_944 = "npm_imported_package_store")
load("@@_main~npm~npm__responselike__2.0.1__links//:defs.bzl", store_945 = "npm_imported_package_store")
load("@@_main~npm~npm__retry__0.12.0__links//:defs.bzl", store_946 = "npm_imported_package_store")
load("@@_main~npm~npm__rfc4648__1.5.4__links//:defs.bzl", store_947 = "npm_imported_package_store")
load("@@_main~npm~npm__right-now__1.0.0__links//:defs.bzl", store_948 = "npm_imported_package_store")
load("@@_main~npm~npm__rimraf__2.7.1__links//:defs.bzl", store_949 = "npm_imported_package_store")
load("@@_main~npm~npm__rimraf__3.0.2__links//:defs.bzl", store_950 = "npm_imported_package_store")
load("@@_main~npm~npm__rollup__2.70.2__links//:defs.bzl", link_951 = "npm_link_imported_package_store", store_951 = "npm_imported_package_store")
load("@@_main~npm~npm__rollup__4.39.0__links//:defs.bzl", link_952 = "npm_link_imported_package_store", store_952 = "npm_imported_package_store")
load("@@_main~npm~npm__rw__1.3.3__links//:defs.bzl", store_953 = "npm_imported_package_store")
load("@@_main~npm~npm__sade__1.8.1__links//:defs.bzl", store_954 = "npm_imported_package_store")
load("@@_main~npm~npm__safe-buffer__5.1.2__links//:defs.bzl", store_955 = "npm_imported_package_store")
load("@@_main~npm~npm__safe-buffer__5.2.1__links//:defs.bzl", store_956 = "npm_imported_package_store")
load("@@_main~npm~npm__safer-buffer__2.1.2__links//:defs.bzl", store_957 = "npm_imported_package_store")
load("@@_main~npm~npm__sax__1.4.1__links//:defs.bzl", store_958 = "npm_imported_package_store")
load("@@_main~npm~npm__scheduler__0.27.0__links//:defs.bzl", store_959 = "npm_imported_package_store")
load("@@_main~npm~npm__schema-utils__3.3.0__links//:defs.bzl", store_960 = "npm_imported_package_store")
load("@@_main~npm~npm__schema-utils__4.3.3__links//:defs.bzl", store_961 = "npm_imported_package_store")
load("@@_main~npm~npm__seedrandom__3.0.5__links//:defs.bzl", store_962 = "npm_imported_package_store")
load("@@_main~npm~npm__segfault-handler__1.3.0__links//:defs.bzl", link_963 = "npm_link_imported_package_store", store_963 = "npm_imported_package_store")
load("@@_main~npm~npm__semver-first-satisfied__1.1.0__links//:defs.bzl", link_964 = "npm_link_imported_package_store", store_964 = "npm_imported_package_store")
load("@@_main~npm~npm__semver__5.7.2__links//:defs.bzl", store_965 = "npm_imported_package_store")
load("@@_main~npm~npm__semver__6.3.1__links//:defs.bzl", store_966 = "npm_imported_package_store")
load("@@_main~npm~npm__semver__7.5.0__links//:defs.bzl", store_967 = "npm_imported_package_store")
load("@@_main~npm~npm__semver__7.7.3__links//:defs.bzl", store_968 = "npm_imported_package_store")
load("@@_main~npm~npm__serialize-javascript__6.0.0__links//:defs.bzl", store_969 = "npm_imported_package_store")
load("@@_main~npm~npm__serialize-javascript__6.0.2__links//:defs.bzl", store_970 = "npm_imported_package_store")
load("@@_main~npm~npm__set-blocking__2.0.0__links//:defs.bzl", store_971 = "npm_imported_package_store")
load("@@_main~npm~npm__set-function-length__1.2.2__links//:defs.bzl", store_972 = "npm_imported_package_store")
load("@@_main~npm~npm__setprototypeof__1.2.0__links//:defs.bzl", store_973 = "npm_imported_package_store")
load("@@_main~npm~npm__shallow-clone__3.0.1__links//:defs.bzl", store_974 = "npm_imported_package_store")
load("@@_main~npm~npm__shallow-copy__0.0.1__links//:defs.bzl", store_975 = "npm_imported_package_store")
load("@@_main~npm~npm__sharp__0.33.5__links//:defs.bzl", store_976 = "npm_imported_package_store")
load("@@_main~npm~npm__shebang-command__2.0.0__links//:defs.bzl", store_977 = "npm_imported_package_store")
load("@@_main~npm~npm__shebang-regex__3.0.0__links//:defs.bzl", store_978 = "npm_imported_package_store")
load("@@_main~npm~npm__signal-exit__3.0.7__links//:defs.bzl", store_979 = "npm_imported_package_store")
load("@@_main~npm~npm__signal-exit__4.1.0__links//:defs.bzl", store_980 = "npm_imported_package_store")
load("@@_main~npm~npm__signum__1.0.0__links//:defs.bzl", store_981 = "npm_imported_package_store")
load("@@_main~npm~npm__simple-swizzle__0.2.4__links//:defs.bzl", store_982 = "npm_imported_package_store")
load("@@_main~npm~npm__sirv__1.0.19__links//:defs.bzl", store_983 = "npm_imported_package_store")
load("@@_main~npm~npm__slash__2.0.0__links//:defs.bzl", store_984 = "npm_imported_package_store")
load("@@_main~npm~npm__smart-buffer__4.2.0__links//:defs.bzl", store_985 = "npm_imported_package_store")
load("@@_main~npm~npm__socks-proxy-agent__7.0.0__links//:defs.bzl", store_986 = "npm_imported_package_store")
load("@@_main~npm~npm__socks-proxy-agent__8.0.5__links//:defs.bzl", store_987 = "npm_imported_package_store")
load("@@_main~npm~npm__socks__2.8.7__links//:defs.bzl", store_988 = "npm_imported_package_store")
load("@@_main~npm~npm__source-map-js__1.2.1__links//:defs.bzl", store_989 = "npm_imported_package_store")
load("@@_main~npm~npm__source-map-support__0.5.21__links//:defs.bzl", link_990 = "npm_link_imported_package_store", store_990 = "npm_imported_package_store")
load("@@_main~npm~npm__source-map__0.6.1__links//:defs.bzl", store_991 = "npm_imported_package_store")
load("@@_main~npm~npm__sourcemap-codec__1.4.8__links//:defs.bzl", store_992 = "npm_imported_package_store")
load("@@_main~npm~npm__sshpk__1.18.0__links//:defs.bzl", store_993 = "npm_imported_package_store")
load("@@_main~npm~npm__ssri__9.0.1__links//:defs.bzl", store_994 = "npm_imported_package_store")
load("@@_main~npm~npm__stack-trace__0.0.9__links//:defs.bzl", store_995 = "npm_imported_package_store")
load("@@_main~npm~npm__static-eval__2.1.1__links//:defs.bzl", store_996 = "npm_imported_package_store")
load("@@_main~npm~npm__statuses__2.0.1__links//:defs.bzl", store_997 = "npm_imported_package_store")
load("@@_main~npm~npm__stream-buffers__3.0.3__links//:defs.bzl", store_998 = "npm_imported_package_store")
load("@@_main~npm~npm__stream-parser__0.3.1__links//:defs.bzl", store_999 = "npm_imported_package_store")
load("@@_main~npm~npm__stream-shift__1.0.3__links//:defs.bzl", store_1000 = "npm_imported_package_store")
load("@@_main~npm~npm__streamsearch__1.1.0__links//:defs.bzl", store_1001 = "npm_imported_package_store")
load("@@_main~npm~npm__string-split-by__1.0.0__links//:defs.bzl", store_1002 = "npm_imported_package_store")
load("@@_main~npm~npm__string-width__1.0.2__links//:defs.bzl", store_1003 = "npm_imported_package_store")
load("@@_main~npm~npm__string-width__4.2.3__links//:defs.bzl", store_1004 = "npm_imported_package_store")
load("@@_main~npm~npm__string-width__5.1.2__links//:defs.bzl", store_1005 = "npm_imported_package_store")
load("@@_main~npm~npm__string_decoder__0.10.31__links//:defs.bzl", store_1006 = "npm_imported_package_store")
load("@@_main~npm~npm__string_decoder__1.1.1__links//:defs.bzl", store_1007 = "npm_imported_package_store")
load("@@_main~npm~npm__string_decoder__1.3.0__links//:defs.bzl", store_1008 = "npm_imported_package_store")
load("@@_main~npm~npm__strip-ansi__3.0.1__links//:defs.bzl", store_1009 = "npm_imported_package_store")
load("@@_main~npm~npm__strip-ansi__6.0.1__links//:defs.bzl", store_1010 = "npm_imported_package_store")
load("@@_main~npm~npm__strip-ansi__7.1.2__links//:defs.bzl", store_1011 = "npm_imported_package_store")
load("@@_main~npm~npm__strip-bom__4.0.0__links//:defs.bzl", store_1012 = "npm_imported_package_store")
load("@@_main~npm~npm__strip-json-comments__2.0.1__links//:defs.bzl", store_1013 = "npm_imported_package_store")
load("@@_main~npm~npm__strip-json-comments__3.1.1__links//:defs.bzl", store_1014 = "npm_imported_package_store")
load("@@_main~npm~npm__strongly-connected-components__1.0.1__links//:defs.bzl", store_1015 = "npm_imported_package_store")
load("@@_main~npm~npm__styled-jsx__5.1.6_324456147__links//:defs.bzl", store_1016 = "npm_imported_package_store")
load("@@_main~npm~npm__supercluster__7.1.5__links//:defs.bzl", store_1017 = "npm_imported_package_store")
load("@@_main~npm~npm__superscript-text__1.0.0__links//:defs.bzl", store_1018 = "npm_imported_package_store")
load("@@_main~npm~npm__supports-color__7.2.0__links//:defs.bzl", store_1019 = "npm_imported_package_store")
load("@@_main~npm~npm__supports-color__8.1.1__links//:defs.bzl", store_1020 = "npm_imported_package_store")
load("@@_main~npm~npm__supports-preserve-symlinks-flag__1.0.0__links//:defs.bzl", store_1021 = "npm_imported_package_store")
load("@@_main~npm~npm__svg-arc-to-cubic-bezier__3.2.0__links//:defs.bzl", store_1022 = "npm_imported_package_store")
load("@@_main~npm~npm__svg-path-bounds__1.0.2__links//:defs.bzl", store_1023 = "npm_imported_package_store")
load("@@_main~npm~npm__svg-path-sdf__1.1.3__links//:defs.bzl", store_1024 = "npm_imported_package_store")
load("@@_main~npm~npm__syncpack__https___codeload.github.com_JamieMason_syncpack_tar.gz_c245af8ea73ce3345d92bbda6c684092a841e262__links//:defs.bzl", link_1025 = "npm_link_imported_package_store", store_1025 = "npm_imported_package_store")
load("@@_main~npm~npm__tailwindcss__4.1.0__links//:defs.bzl", link_1026 = "npm_link_imported_package_store", store_1026 = "npm_imported_package_store")
load("@@_main~npm~npm__tapable__2.3.0__links//:defs.bzl", store_1027 = "npm_imported_package_store")
load("@@_main~npm~npm__tar-fs__1.16.6__links//:defs.bzl", store_1028 = "npm_imported_package_store")
load("@@_main~npm~npm__tar-fs__2.1.1__links//:defs.bzl", store_1029 = "npm_imported_package_store")
load("@@_main~npm~npm__tar-stream__1.6.2__links//:defs.bzl", store_1030 = "npm_imported_package_store")
load("@@_main~npm~npm__tar-stream__2.2.0__links//:defs.bzl", store_1031 = "npm_imported_package_store")
load("@@_main~npm~npm__tar__4.4.19__links//:defs.bzl", store_1032 = "npm_imported_package_store")
load("@@_main~npm~npm__tar__6.2.1__links//:defs.bzl", store_1033 = "npm_imported_package_store")
load("@@_main~npm~npm__tar__7.5.2__links//:defs.bzl", store_1034 = "npm_imported_package_store")
load("@@_main~npm~npm__terser-webpack-plugin__5.3.14_webpack_5.76.3__links//:defs.bzl", store_1035 = "npm_imported_package_store")
load("@@_main~npm~npm__terser__5.44.0__links//:defs.bzl", store_1036 = "npm_imported_package_store")
load("@@_main~npm~npm__test-exclude__7.0.1__links//:defs.bzl", store_1037 = "npm_imported_package_store")
load("@@_main~npm~npm__through2__0.6.5__links//:defs.bzl", store_1038 = "npm_imported_package_store")
load("@@_main~npm~npm__through2__2.0.5__links//:defs.bzl", store_1039 = "npm_imported_package_store")
load("@@_main~npm~npm__through__2.3.8__links//:defs.bzl", store_1040 = "npm_imported_package_store")
load("@@_main~npm~npm__tightrope__0.1.0__links//:defs.bzl", store_1041 = "npm_imported_package_store")
load("@@_main~npm~npm__tiny-emitter__2.1.0__links//:defs.bzl", store_1042 = "npm_imported_package_store")
load("@@_main~npm~npm__tinycolor2__1.6.0__links//:defs.bzl", store_1043 = "npm_imported_package_store")
load("@@_main~npm~npm__tinyqueue__2.0.3__links//:defs.bzl", store_1044 = "npm_imported_package_store")
load("@@_main~npm~npm__tmp-promise__3.0.3__links//:defs.bzl", store_1045 = "npm_imported_package_store")
load("@@_main~npm~npm__tmp__0.0.33__links//:defs.bzl", store_1046 = "npm_imported_package_store")
load("@@_main~npm~npm__tmp__0.2.5__links//:defs.bzl", store_1047 = "npm_imported_package_store")
load("@@_main~npm~npm__to-buffer__1.2.2__links//:defs.bzl", store_1048 = "npm_imported_package_store")
load("@@_main~npm~npm__to-float32__1.1.0__links//:defs.bzl", store_1049 = "npm_imported_package_store")
load("@@_main~npm~npm__to-px__1.0.1__links//:defs.bzl", store_1050 = "npm_imported_package_store")
load("@@_main~npm~npm__to-readable-stream__2.1.0__links//:defs.bzl", store_1051 = "npm_imported_package_store")
load("@@_main~npm~npm__to-regex-range__5.0.1__links//:defs.bzl", store_1052 = "npm_imported_package_store")
load("@@_main~npm~npm__toidentifier__1.0.1__links//:defs.bzl", store_1053 = "npm_imported_package_store")
load("@@_main~npm~npm__topojson-client__3.1.0__links//:defs.bzl", store_1054 = "npm_imported_package_store")
load("@@_main~npm~npm__totalist__1.1.0__links//:defs.bzl", store_1055 = "npm_imported_package_store")
load("@@_main~npm~npm__tough-cookie__2.5.0__links//:defs.bzl", store_1056 = "npm_imported_package_store")
load("@@_main~npm~npm__tr46__0.0.3__links//:defs.bzl", store_1057 = "npm_imported_package_store")
load("@@_main~npm~npm__tslib__2.8.1__links//:defs.bzl", link_1058 = "npm_link_imported_package_store", store_1058 = "npm_imported_package_store")
load("@@_main~npm~npm__tunnel-agent__0.6.0__links//:defs.bzl", store_1059 = "npm_imported_package_store")
load("@@_main~npm~npm__tweetnacl__0.14.5__links//:defs.bzl", store_1060 = "npm_imported_package_store")
load("@@_main~npm~npm__type-fest__0.10.0__links//:defs.bzl", store_1061 = "npm_imported_package_store")
load("@@_main~npm~npm__type__2.7.3__links//:defs.bzl", store_1062 = "npm_imported_package_store")
load("@@_main~npm~npm__typed-array-buffer__1.0.3__links//:defs.bzl", store_1063 = "npm_imported_package_store")
load("@@_main~npm~npm__typed-function__4.2.1__links//:defs.bzl", store_1064 = "npm_imported_package_store")
load("@@_main~npm~npm__typedarray-pool__1.2.0__links//:defs.bzl", store_1065 = "npm_imported_package_store")
load("@@_main~npm~npm__typedarray__0.0.6__links//:defs.bzl", store_1066 = "npm_imported_package_store")
load("@@_main~npm~npm__typeof-article__0.1.1__links//:defs.bzl", store_1067 = "npm_imported_package_store")
load("@@_main~npm~npm__typescript__5.6.3__links//:defs.bzl", store_1068 = "npm_imported_package_store")
load("@@_main~npm~npm__typescript__5.8.2__links//:defs.bzl", link_1069 = "npm_link_imported_package_store", store_1069 = "npm_imported_package_store")
load("@@_main~npm~npm__ufo__1.6.1__links//:defs.bzl", store_1070 = "npm_imported_package_store")
load("@@_main~npm~npm__unbzip2-stream__1.4.3__links//:defs.bzl", store_1071 = "npm_imported_package_store")
load("@@_main~npm~npm__undici-types__5.26.5__links//:defs.bzl", store_1072 = "npm_imported_package_store")
load("@@_main~npm~npm__undici-types__6.19.8__links//:defs.bzl", store_1073 = "npm_imported_package_store")
load("@@_main~npm~npm__undici-types__6.21.0__links//:defs.bzl", store_1074 = "npm_imported_package_store")
load("@@_main~npm~npm__unique-filename__2.0.1__links//:defs.bzl", store_1075 = "npm_imported_package_store")
load("@@_main~npm~npm__unique-slug__3.0.0__links//:defs.bzl", store_1076 = "npm_imported_package_store")
load("@@_main~npm~npm__universalify__0.1.2__links//:defs.bzl", store_1077 = "npm_imported_package_store")
load("@@_main~npm~npm__universalify__2.0.1__links//:defs.bzl", store_1078 = "npm_imported_package_store")
load("@@_main~npm~npm__unix-dgram__2.0.7__links//:defs.bzl", store_1079 = "npm_imported_package_store")
load("@@_main~npm~npm__unquote__1.1.1__links//:defs.bzl", store_1080 = "npm_imported_package_store")
load("@@_main~npm~npm__unused__0.2.2__links//:defs.bzl", link_1081 = "npm_link_imported_package_store", store_1081 = "npm_imported_package_store")
load("@@_main~npm~npm__update-browserslist-db__1.1.4_browserslist_4.27.0__links//:defs.bzl", store_1082 = "npm_imported_package_store")
load("@@_main~npm~npm__update-diff__1.1.0__links//:defs.bzl", store_1083 = "npm_imported_package_store")
load("@@_main~npm~npm__uri-js__4.4.1__links//:defs.bzl", store_1084 = "npm_imported_package_store")
load("@@_main~npm~npm__util-deprecate__1.0.2__links//:defs.bzl", store_1085 = "npm_imported_package_store")
load("@@_main~npm~npm__uuid__3.4.0__links//:defs.bzl", store_1086 = "npm_imported_package_store")
load("@@_main~npm~npm__uuid__8.3.2__links//:defs.bzl", link_1087 = "npm_link_imported_package_store", store_1087 = "npm_imported_package_store")
load("@@_main~npm~npm__uvu__0.5.3__links//:defs.bzl", link_1088 = "npm_link_imported_package_store", store_1088 = "npm_imported_package_store")
load("@@_main~npm~npm__v8-to-istanbul__9.3.0__links//:defs.bzl", store_1089 = "npm_imported_package_store")
load("@@_main~npm~npm__verror__1.10.0__links//:defs.bzl", store_1090 = "npm_imported_package_store")
load("@@_main~npm~npm__vite-node__1.6.1_374860537__links//:defs.bzl", store_1091 = "npm_imported_package_store")
load("@@_main~npm~npm__vite__5.4.21_374860537__links//:defs.bzl", store_1092 = "npm_imported_package_store")
load("@@_main~npm~npm__vt-pbf__3.1.3__links//:defs.bzl", store_1093 = "npm_imported_package_store")
load("@@_main~npm~npm__watchpack__2.4.4__links//:defs.bzl", store_1094 = "npm_imported_package_store")
load("@@_main~npm~npm__weak-map__1.0.8__links//:defs.bzl", store_1095 = "npm_imported_package_store")
load("@@_main~npm~npm__webgl-context__2.2.0__links//:defs.bzl", store_1096 = "npm_imported_package_store")
load("@@_main~npm~npm__webidl-conversions__3.0.1__links//:defs.bzl", store_1097 = "npm_imported_package_store")
load("@@_main~npm~npm__webpack-bundle-analyzer__4.5.0_bufferutil_4.0.8__links//:defs.bzl", link_1098 = "npm_link_imported_package_store", store_1098 = "npm_imported_package_store")
load("@@_main~npm~npm__webpack-cli__5.0.1_webpack_5.76.3__links//:defs.bzl", link_1099 = "npm_link_imported_package_store", store_1099 = "npm_imported_package_store")
load("@@_main~npm~npm__webpack-merge__5.10.0__links//:defs.bzl", store_1100 = "npm_imported_package_store")
load("@@_main~npm~npm__webpack-sources__3.3.3__links//:defs.bzl", store_1101 = "npm_imported_package_store")
load("@@_main~npm~npm__webpack__5.76.3_webpack-cli_5.0.1__links//:defs.bzl", link_1102 = "npm_link_imported_package_store", store_1102 = "npm_imported_package_store")
load("@@_main~npm~npm__whatwg-url__5.0.0__links//:defs.bzl", store_1103 = "npm_imported_package_store")
load("@@_main~npm~npm__which-typed-array__1.1.19__links//:defs.bzl", store_1104 = "npm_imported_package_store")
load("@@_main~npm~npm__which__2.0.2__links//:defs.bzl", store_1105 = "npm_imported_package_store")
load("@@_main~npm~npm__wide-align__1.1.5__links//:defs.bzl", store_1106 = "npm_imported_package_store")
load("@@_main~npm~npm__wildcard__2.0.1__links//:defs.bzl", store_1107 = "npm_imported_package_store")
load("@@_main~npm~npm__wordwrap__0.0.3__links//:defs.bzl", store_1108 = "npm_imported_package_store")
load("@@_main~npm~npm__workerpool__6.2.1__links//:defs.bzl", store_1109 = "npm_imported_package_store")
load("@@_main~npm~npm__world-calendars__1.0.4__links//:defs.bzl", store_1110 = "npm_imported_package_store")
load("@@_main~npm~npm__wrap-ansi__7.0.0__links//:defs.bzl", store_1111 = "npm_imported_package_store")
load("@@_main~npm~npm__wrap-ansi__8.1.0__links//:defs.bzl", store_1112 = "npm_imported_package_store")
load("@@_main~npm~npm__wrappy__1.0.2__links//:defs.bzl", store_1113 = "npm_imported_package_store")
load("@@_main~npm~npm__ws__7.5.10_bufferutil_4.0.8__links//:defs.bzl", store_1114 = "npm_imported_package_store")
load("@@_main~npm~npm__ws__8.13.0_bufferutil_4.0.8__links//:defs.bzl", store_1115 = "npm_imported_package_store")
load("@@_main~npm~npm__ws__8.18.3_bufferutil_4.0.8__links//:defs.bzl", store_1116 = "npm_imported_package_store")
load("@@_main~npm~npm__xml__1.0.1__links//:defs.bzl", store_1117 = "npm_imported_package_store")
load("@@_main~npm~npm__xtend__2.2.0__links//:defs.bzl", store_1118 = "npm_imported_package_store")
load("@@_main~npm~npm__xtend__4.0.2__links//:defs.bzl", store_1119 = "npm_imported_package_store")
load("@@_main~npm~npm__y18n__5.0.8__links//:defs.bzl", store_1120 = "npm_imported_package_store")
load("@@_main~npm~npm__yallist__3.1.1__links//:defs.bzl", store_1121 = "npm_imported_package_store")
load("@@_main~npm~npm__yallist__4.0.0__links//:defs.bzl", store_1122 = "npm_imported_package_store")
load("@@_main~npm~npm__yallist__5.0.0__links//:defs.bzl", store_1123 = "npm_imported_package_store")
load("@@_main~npm~npm__yargs-parser__20.2.4__links//:defs.bzl", store_1124 = "npm_imported_package_store")
load("@@_main~npm~npm__yargs-parser__21.1.1__links//:defs.bzl", store_1125 = "npm_imported_package_store")
load("@@_main~npm~npm__yargs-unparser__2.0.0__links//:defs.bzl", store_1126 = "npm_imported_package_store")
load("@@_main~npm~npm__yargs__16.2.0__links//:defs.bzl", store_1127 = "npm_imported_package_store")
load("@@_main~npm~npm__yargs__17.7.1__links//:defs.bzl", store_1128 = "npm_imported_package_store")
load("@@_main~npm~npm__yargs__17.7.2__links//:defs.bzl", store_1129 = "npm_imported_package_store")
load("@@_main~npm~npm__yauzl__2.10.0__links//:defs.bzl", store_1130 = "npm_imported_package_store")
load("@@_main~npm~npm__yocto-queue__0.1.0__links//:defs.bzl", store_1131 = "npm_imported_package_store")
load("@@_main~npm~npm__zod__3.21.4__links//:defs.bzl", store_1132 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = [], prod = True, dev = True):
    ...
    if link:
        if bazel_package == "js/private/worker/src":
            ...
            link_1058("{}/tslib".format(name), True, name, "tslib")
            link_1069("{}/typescript".format(name), True, name, "typescript")
            link_targets = [
            ...
            link_754("{}/meaning-of-life".format(name), True, name, "meaning-of-life")
            link_789("{}/mobx-react".format(name), True, name, "mobx-react")
            link_790("{}/mobx".format(name), True, name, "mobx")
            link_807("{}/ms".format(name), True, name, "ms")
            link_922("{}/react".format(name), True, name, "react")
            link_951("{}/rollup".format(name), True, name, "rollup")
            link_1088("{}/uvu".format(name), True, name, "uvu")
            _fp_link_2(name)
            _fp_link_8(name)
            _fp_link_9(name)
            link_targets = [
            ...
            link_1087("{}/uuid".format(name), False, name, "uuid")
            link_targets = [
                ":{}/acorn".format(name),
                ":{}/uuid".format(name),
            ]
            ...
            link_631("{}/inline-fixtures".format(name), True, name, "inline-fixtures")
            link_698("{}/jsonpath-plus".format(name), True, name, "jsonpath-plus")
            link_1069("{}/typescript".format(name), True, name, "typescript")
            link_targets = [
            ...
            link_607("{}/handlebars-helpers/helper-date".format(name), True, name, "handlebars-helpers/helper-date")
            link_608("{}/hot-shots".format(name), True, name, "hot-shots")
            link_632("{}/inline-fixtures".format(name), True, name, "inline-fixtures")
            link_692("{}/json-stable-stringify".format(name), True, name, "json-stable-stringify")
            link_735("{}/lodash".format(name), True, name, "lodash")
            link_823("{}/node-gyp".format(name), True, name, "node-gyp")
            link_887("{}/plotly.js".format(name), True, name, "plotly.js")
            link_888("{}/pngjs".format(name), True, name, "pngjs")
            link_906("{}/protoc-gen-grpc".format(name), True, name, "protoc-gen-grpc")
            link_914("{}/puppeteer".format(name), True, name, "puppeteer")
            link_963("{}/segfault-handler".format(name), True, name, "segfault-handler")
            link_964("{}/semver-first-satisfied".format(name), True, name, "semver-first-satisfied")
            link_1025("{}/syncpack".format(name), True, name, "syncpack")
            link_1069("{}/typescript".format(name), True, name, "typescript")
            link_1081("{}/unused".format(name), True, name, "unused")
            link_1098("{}/webpack-bundle-analyzer".format(name), True, name, "webpack-bundle-analyzer")
            _fp_link_10(name)
            link_targets = [
            ...
            link_818("{}/next".format(name), False, name, "next")
            link_921("{}/react-dom".format(name), False, name, "react-dom")
            link_923("{}/react".format(name), False, name, "react")
            link_1026("{}/tailwindcss".format(name), True, name, "tailwindcss")
            link_targets = [
                ":{}/next".format(name),
            ...
            link_676("{}/jasmine".format(name), False, name, "jasmine")
            link_targets = [
                ":{}/@types/node".format(name),
                ":{}/jasmine".format(name),
            ]
            ...
            link_752("{}/mathjs".format(name), False, name, "mathjs")
            link_762("{}/mini-css-extract-plugin".format(name), True, name, "mini-css-extract-plugin")
            link_1099("{}/webpack-cli".format(name), True, name, "webpack-cli")
            link_1102("{}/webpack".format(name), True, name, "webpack")
            link_targets = [
            ...
            link_791("{}/mocha-junit-reporter".format(name), True, name, "mocha-junit-reporter")
            link_792("{}/mocha-multi-reporters".format(name), True, name, "mocha-multi-reporters")
            link_793("{}/mocha".format(name), True, name, "mocha")
            link_targets = [
            ...
            link_990("{}/source-map-support".format(name), True, name, "source-map-support")
