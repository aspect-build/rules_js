...
def npm_link_all_packages(imported_links = []):
    ...
    if link:
        if bazel_package == "js/private/worker/src":
            ...
            link_577("handlebars-helpers/helper-date")
            ...
            link_660("json-stable-stringify")
            ...
            link_600("inline-fixtures")
            link_targets.append(":node_modules/inline-fixtures")
            link_666("jsonpath-plus")
            ...
            link_748("mocha-junit-reporter")
            link_targets.append(":node_modules/mocha-junit-reporter")
            link_749("mocha-multi-reporters")
