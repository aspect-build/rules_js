"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package webpack-bundle-analyzer@4.5.0_bufferutil@4.0.7"
...
def _webpack_bundle_analyzer_internal(name, link_root_name, **kwargs):
    store_target_name = ".aspect_rules_js/{}/webpack-bundle-analyzer@4.5.0_bufferutil@4.0.7".format(link_root_name)
    _directory_path(
