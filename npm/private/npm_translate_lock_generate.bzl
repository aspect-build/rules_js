...
# buildifier: disable=function-docstring
def generate_repository_files(rctx_name, attr, importers, packages, replace_packages, exclude_package_contents_config, patched_dependencies, only_built_dependencies, root_package, default_registry, npm_registries, npm_auth):
    ...
    npm_imports = helpers.get_npm_imports(importers, packages, replace_packages, patched_dependencies, only_built_dependencies, root_package, rctx_name, attr, attr.lifecycle_hooks, attr.lifecycle_hooks_execution_requirements, attr.lifecycle_hooks_use_default_shell_env, npm_registries, default_registry, npm_auth, exclude_package_contents_config)
