...
load("@@aspect_rules_js~~npm~npm__debug__4.4.3__links//:defs.bzl", store_0 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~npm__ms__2.1.3__links//:defs.bzl", store_1 = "npm_imported_package_store")
