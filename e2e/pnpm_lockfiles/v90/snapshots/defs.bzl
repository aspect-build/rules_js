...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_foo_jsonify_https_github.com_aspect-build_test-packages_releases_download_0.0.0_foo-jsonify-0.0.0.tgz__links//:defs.bzl", link_13 = "npm_link_imported_package_store", store_13 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_rollup_plugin-typescript_8.2.1_rollup_2.14.0_tslib_2.8.1_typescript_5.5.2__links//:defs.bzl", link_15 = "npm_link_imported_package_store", store_15 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_rollup_pluginutils_3.1.0_rollup_2.14.0__links//:defs.bzl", store_16 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__debug_https_codeload.github.com_ngokevin_debug_tar.gz_9742c5f383a6f8046241920156236ade8ec30d53__links//:defs.bzl", link_25 = "npm_link_imported_package_store", store_25 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__dequal__2.0.3__links//:defs.bzl", store_26 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__diff_https_github.com_kpdecker_jsdiff_archive_refs_tags_v5.2.0.tar.gz__links//:defs.bzl", store_27 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__hello_https_gitpkg.vercel.app_EqualMa_gitpkg-hello_packages_hello__links//:defs.bzl", link_35 = "npm_link_imported_package_store", store_35 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__jquery_https_codeload.github.com_jquery_jquery_tar.gz_e61fccb9d736235b4b011f89cba6866bc0b8997d__links//:defs.bzl", link_43 = "npm_link_imported_package_store", store_43 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__kleur__4.1.5__links//:defs.bzl", store_44 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__lodash_file_.._vendored_lodash-4.17.21.tgz__links//:defs.bzl", link_45 = "npm_link_imported_package_store", store_45 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__meaning-of-life_1.0.0_patch_hash_o3deharooos255qt5xdujc3cuq__links//:defs.bzl", link_46 = "npm_link_imported_package_store", store_46 = "npm_imported_package_store")
