    ...
    if is_root:
        _npm_local_package_store(
            ...
            deps = {
                "//<LOCKVERSION>:.aspect_rules_js/@scoped+a@0.0.0": "@scoped/a",
                "//<LOCKVERSION>:.aspect_rules_js/@scoped+b@0.0.0": "@scoped/b",
                "//<LOCKVERSION>:.aspect_rules_js/@scoped+c@0.0.0": "@scoped/c",
                "//<LOCKVERSION>:.aspect_rules_js/hello@https+gitpkg.vercel.app+EqualMa+gitpkg-hello+packages+hello": "hello",
                "//<LOCKVERSION>:.aspect_rules_js/@foo+jsonify@https+github.com+aspect-build+test-packages+releases+download+0.0.0+@foo-jsonify-0.0.0.tgz": "jsonify",
            },
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
