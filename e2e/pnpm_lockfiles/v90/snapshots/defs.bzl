...
load("@lock-<LOCKVERSION>__at_esbuild_aix-ppc64__0.27.0__links//:defs.bzl", store_10 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_android-arm64__0.27.0__links//:defs.bzl", store_11 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_android-arm__0.27.0__links//:defs.bzl", store_12 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_android-x64__0.27.0__links//:defs.bzl", store_13 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_darwin-arm64__0.27.0__links//:defs.bzl", store_14 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_darwin-x64__0.27.0__links//:defs.bzl", store_15 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_freebsd-arm64__0.27.0__links//:defs.bzl", store_16 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_freebsd-x64__0.27.0__links//:defs.bzl", store_17 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-arm64__0.27.0__links//:defs.bzl", store_18 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-arm__0.27.0__links//:defs.bzl", store_19 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-ia32__0.27.0__links//:defs.bzl", store_20 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-loong64__0.27.0__links//:defs.bzl", store_21 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-mips64el__0.27.0__links//:defs.bzl", store_22 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-ppc64__0.27.0__links//:defs.bzl", store_23 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-riscv64__0.27.0__links//:defs.bzl", store_24 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-s390x__0.27.0__links//:defs.bzl", store_25 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_linux-x64__0.27.0__links//:defs.bzl", store_26 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_netbsd-arm64__0.27.0__links//:defs.bzl", store_27 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_netbsd-x64__0.27.0__links//:defs.bzl", store_28 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_openbsd-arm64__0.27.0__links//:defs.bzl", store_29 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_openbsd-x64__0.27.0__links//:defs.bzl", store_30 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_openharmony-arm64__0.27.0__links//:defs.bzl", store_31 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_sunos-x64__0.27.0__links//:defs.bzl", store_32 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_win32-arm64__0.27.0__links//:defs.bzl", store_33 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_win32-ia32__0.27.0__links//:defs.bzl", store_34 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_esbuild_win32-x64__0.27.0__links//:defs.bzl", store_35 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_foo_jsonify__https___github.com_aspect-build_test-packages_releases_download_0.0.0__foo-jsonify-0.0.0.tgz__links//:defs.bzl", link_36 = "npm_link_imported_package_store_internal", store_36 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_isaacs_cliui__8.0.2__links//:defs.bzl", link_37 = "npm_link_imported_package_store_internal", store_37 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_rollup_plugin-typescript__8.2.1_626159424__links//:defs.bzl", link_38 = "npm_link_imported_package_store_internal", store_38 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_rollup_pluginutils__3.1.0_rollup_2.14.0__links//:defs.bzl", store_39 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__at_types_archiver__5.3.1__links//:defs.bzl", link_40 = "npm_link_imported_package_store_internal", store_40 = "npm_imported_package_store_internal")
...
load("@lock-<LOCKVERSION>__ansi-styles__4.3.0__links//:defs.bzl", store_48 = "npm_imported_package_store_internal")
load("@lock-<LOCKVERSION>__ansi-styles__6.2.3__links//:defs.bzl", store_49 = "npm_imported_package_store_internal")
...
load("@lock-<LOCKVERSION>__meaning-of-life__1.0.0_1287509853__links//:defs.bzl", link_81 = "npm_link_imported_package_store_internal", store_81 = "npm_imported_package_store_internal")
...
def npm_link_all_packages(name = "node_modules", imported_links = [], prod = True, dev = True):
    ...
    if is_importer:
        if bazel_package == "<LOCKVERSION>":
            ...
            link_36("jsonify")
            link_37()
            link_38("rollup-plugin-with-peers")
            link_40(dev=True)
            link_44(dev=True)
            link_44("alias-types-node", dev=True)
