...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_types_node__16.18.97__links//:defs.bzl", link_6 = "npm_link_imported_package_store", store_6 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__dequal__2.0.3__links//:defs.bzl", store_7 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__diff__5.2.0__links//:defs.bzl", store_8 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__fsevents__2.3.3__links//:defs.bzl", store_9 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__kleur__4.1.5__links//:defs.bzl", store_10 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__meaning-of-life__1.0.0__o3deharooos255qt5xdujc3cuq__links//:defs.bzl", link_11 = "npm_link_imported_package_store", store_11 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__mri__1.2.0__links//:defs.bzl", store_12 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = []):
    ...
    if is_root:
        ...
        store_6(name = "{}/@types/node".format(name))
        store_7(name = "{}/dequal".format(name))
        store_8(name = "{}/diff".format(name))
        store_9(name = "{}/fsevents".format(name))
        store_10(name = "{}/kleur".format(name))
        store_11(name = "{}/meaning-of-life".format(name))
        store_12(name = "{}/mri".format(name))
    ...
    if link:
        if bazel_package == "<LOCKVERSION>":
            ...
            scope_targets["@aspect-test"] = scope_targets["@aspect-test"] + [link_targets[-1]] if "@aspect-test" in scope_targets else [link_targets[-1]]
            link_6(name = "{}/@types/node".format(name))
            ...
            link_11(name = "{}/meaning-of-life".format(name))
