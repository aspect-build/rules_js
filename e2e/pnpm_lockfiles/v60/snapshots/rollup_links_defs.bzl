"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package rollup@3.2.5"
...
# Generated npm_package_store targets for npm package rollup@3.2.5
# buildifier: disable=function-docstring
def npm_imported_package_store(name):
    root_package = "<LOCKVERSION>"
    is_root = native.package_name() == root_package
    if not is_root:
        msg = "No store links in bazel package '%s' for npm package npm package rollup@3.2.5. This is neither the root package nor a link package of this package." % native.package_name()
        fail(msg)
    ...
    deps = {
        ...
        ":.aspect_rules_js/{}/rollup@3.2.5/pkg".format(link_root_name): "rollup",
    }
    ref_deps = {
        ":.aspect_rules_js/{}/fsevents@2.3.3/ref".format(link_root_name): "fsevents",
    }

    store_target_name = ".aspect_rules_js/{}/rollup@3.2.5".format(link_root_name)
    ...
    _npm_package_store(
        ...
        src = "{}/pkg_lc".format(store_target_name) if False else "@@aspect_rules_js~~npm~lock-<LOCKVERSION>__rollup__3.2.5//:pkg",
        package = "rollup",
        version = "3.2.5",
        dev = False,
        deps = ref_deps,
    ...
    _npm_package_store(
        ...
        src = None if True else "@@aspect_rules_js~~npm~lock-<LOCKVERSION>__rollup__3.2.5//:pkg",
        package = "rollup",
        version = "3.2.5",
        dev = False,
        deps = deps,
...
# Generated npm_package_store and npm_link_package_store targets for npm package rollup@3.2.5
# buildifier: disable=function-docstring
...
def npm_link_imported_package(
    ...
    if fail_if_no_link and not is_root and not link:
        msg = "Nothing to link in bazel package '%s' for npm package npm package rollup@3.2.5. This is neither the root package nor a link package of this package." % native.package_name()
        fail(msg)
