...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_rollup_plugin-typescript_8.2.1_rollup_3.29.4_tslib_2.6.3_typescript_5.5.2__links//:defs.bzl", link_17 = "npm_link_imported_package_store", store_17 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_rollup_pluginutils_3.1.0_rollup_3.29.4__links//:defs.bzl", store_18 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__github.com_jquery_jquery_e61fccb9d736235b4b011f89cba6866bc0b8997d__links//:defs.bzl", link_29 = "npm_link_imported_package_store", store_29 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__github.com_ngokevin_debug_9742c5f383a6f8046241920156236ade8ec30d53__links//:defs.bzl", link_30 = "npm_link_imported_package_store", store_30 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__kleur__4.1.5__links//:defs.bzl", store_39 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__meaning-of-life_1.0.0_patch_hash_o3deharooos255qt5xdujc3cuq__links//:defs.bzl", link_40 = "npm_link_imported_package_store", store_40 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__mri__1.2.0__links//:defs.bzl", store_41 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__ms__0.7.3__links//:defs.bzl", store_42 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__path-parse__1.0.7__links//:defs.bzl", store_43 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__picomatch__2.3.1__links//:defs.bzl", store_44 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_archiver_5.3.1__links//:defs.bzl", link_45 = "npm_link_imported_package_store", store_45 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_estree_0.0.39__links//:defs.bzl", store_46 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_glob_8.1.0__links//:defs.bzl", store_47 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_minimatch_5.1.2__links//:defs.bzl", store_48 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_node_16.18.11__links//:defs.bzl", link_49 = "npm_link_imported_package_store", store_49 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_sizzle_2.3.9__links//:defs.bzl", link_50 = "npm_link_imported_package_store", store_50 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = []):
    ...
    if link:
        if bazel_package == "<LOCKVERSION>":
            ...
            link_29("{}/jquery-git-ssh-e61fccb".format(name), link_root_name = name, link_alias = "jquery-git-ssh-e61fccb")
            link_targets.append(":{}/jquery-git-ssh-e61fccb".format(name))
            link_30("{}/debug".format(name), link_root_name = name, link_alias = "debug")
            ...
            link_40("{}/meaning-of-life".format(name), link_root_name = name, link_alias = "meaning-of-life")
            link_targets.append(":{}/meaning-of-life".format(name))
            link_45("{}/@types/archiver".format(name), link_root_name = name, link_alias = "@types/archiver")
            ...
            link_49("{}/@types/node".format(name), link_root_name = name, link_alias = "@types/node")
            link_targets.append(":{}/@types/node".format(name))
            if "@types" not in scope_targets:
                scope_targets["@types"] = [link_targets[-1]]
            else:
                scope_targets["@types"].append(link_targets[-1])
            link_49("{}/alias-types-node".format(name), link_root_name = name, link_alias = "alias-types-node")
            link_targets.append(":{}/alias-types-node".format(name))
            link_50("{}/alias-only-sizzle".format(name), link_root_name = name, link_alias = "alias-only-sizzle")
    ...
    if is_root:
        _npm_local_package_store(
            ...
            deps = {
                "//<LOCKVERSION>:.aspect_rules_js/{}/link_..+projects+a@0.0.0".format(name): "@scoped/a",
                "//<LOCKVERSION>:.aspect_rules_js/{}/link_..+projects+b@0.0.0".format(name): "@scoped/b",
                "//<LOCKVERSION>:.aspect_rules_js/{}/file_..+projects+c_@scoped+b@projects+b@0.0.0".format(name): "@scoped/c",
