"""@generated by npm_translate_lock(name = "lock-v60", pnpm_lock = "@//v60:pnpm-lock.yaml")"""

load("@aspect_rules_js//npm:repositories.bzl", "npm_import")

# Generated npm_import repository rules corresponding to npm packages in @//v60:pnpm-lock.yaml
# buildifier: disable=function-docstring
def npm_repositories():
    npm_import(
        name = "lock-v60__ansi-regex__5.0.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "ansi-regex",
    ...
    npm_import(
        name = "lock-v60__ansi-regex__6.2.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "ansi-regex",
    ...
    npm_import(
        name = "lock-v60__ansi-styles__4.3.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "ansi-styles",
    ...
    npm_import(
        name = "lock-v60__ansi-styles__6.2.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "ansi-styles",
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_a__5.0.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["@aspect-test-a-bad-scope", "@aspect-test-custom-scope/a", "@aspect-test/a", "@aspect-test/a2", "aspect-test-a-no-scope", "aspect-test-a/no-at"],
        },
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_b__5.0.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["@aspect-test/b"],
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_c__2.0.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["@aspect-test/c"],
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_c__2.0.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_c__2.0.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "@aspect-test/c",
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_d__2.0.0_at_aspect-test_c_2.0.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_d__2.0.0_at_aspect-test_c_2.0.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_d__2.0.0_at_aspect-test_c_2.0.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "@aspect-test/d",
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_e__1.0.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["@aspect-test/e"],
    ...
    npm_import(
        name = "lock-v60__at_aspect-test_h__1.0.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["@aspect-test/h-is-only-optional"],
        },
    ...
    npm_import(
        name = "lock-v60__at_foo_jsonify__at_github.com_aspect-build_test-packages_releases_download_0.0.0_at_foo-jsonify-0.0.0.tgz",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["jsonify"],
    ...
    npm_import(
        name = "lock-v60__at_isaacs_cliui__8.0.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["@isaacs/cliui"],
    ...
    npm_import(
        name = "lock-v60__at_rollup_plugin-typescript__8.2.1_1813138439",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["rollup-plugin-with-peers"],
        },
    ...
    npm_import(
        name = "lock-v60__at_rollup_pluginutils__3.1.0_rollup_3.29.4",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__at_types_archiver__5.3.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["@types/archiver"],
    ...
    npm_import(
        name = "lock-v60__at_types_estree__0.0.39",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__at_types_glob__8.1.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "@types/glob",
    ...
    npm_import(
        name = "lock-v60__at_types_minimatch__5.1.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__at_types_node__18.19.54",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["@types/node", "alias-types-node"],
    ...
    npm_import(
        name = "lock-v60__at_types_sizzle__2.3.10",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["alias-only-sizzle"],
        },
    ...
    npm_import(
        name = "lock-v60__color-convert__2.0.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__color-name__1.1.4",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "color-name",
    ...
    npm_import(
        name = "lock-v60__debug__github.com_ngokevin_debug_9742c5f383a6f8046241920156236ade8ec30d53",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["debug"],
    ...
    npm_import(
        name = "lock-v60__diff__at_github.com_kpdecker_jsdiff_archive_refs_tags_v5.2.0.tar.gz",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "diff",
    ...
    npm_import(
        name = "lock-v60__eastasianwidth__0.2.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__emoji-regex__8.0.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "emoji-regex",
    ...
    npm_import(
        name = "lock-v60__emoji-regex__9.2.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "emoji-regex",
    ...
    npm_import(
        name = "lock-v60__estree-walker__1.0.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__fsevents__2.3.3",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "fsevents",
    ...
    npm_import(
        name = "lock-v60__function-bind__1.1.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__hello__at_gitpkg.vercel.app_EqualMa_gitpkg-hello_packages_hello",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["hello"],
    ...
    npm_import(
        name = "lock-v60__is-core-module__2.16.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__is-fullwidth-code-point__3.0.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__is-odd__3.0.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["is-odd", "is-odd-alias"],
        },
        package = "is-odd",
        version = "3.0.1",
    ...
    npm_import(
        name = "lock-v60__jquery__github.com_jquery_jquery_399b201bb3143a3952894cf3489b4848fc003967",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["jquery-git-ssh-399b201"],
        },
        package = "jquery",
    ...
    npm_import(
        name = "lock-v60__jquery__github.com_jquery_jquery_e61fccb9d736235b4b011f89cba6866bc0b8997d",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["jquery-git-ssh-e61fccb"],
        },
        package = "jquery",
    ...
    npm_import(
        name = "lock-v60__lodash__4.17.21",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
    ...
    npm_import(
        name = "lock-v60__lodash__file_.._vendored_lodash-4.17.21.tgz",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["lodash"],
    ...
    npm_import(
        name = "lock-v60__meaning-of-life__1.0.0_o3deharooos255qt5xdujc3cuq",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["meaning-of-life"],
        ...
        patches = ["@//v60:patches/meaning-of-life@1.0.0-pnpm.patch"],
        patch_args = ["-p1"],
    )

    npm_import(
        name = "lock-v60__mri__1.2.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "mri",
    ...
    npm_import(
        name = "lock-v60__path-parse__1.0.7",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "path-parse",
    ...
    npm_import(
        name = "lock-v60__picomatch__2.3.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "picomatch",
    ...
    npm_import(
        name = "lock-v60__resolve__1.22.10",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "resolve",
    ...
    npm_import(
        name = "lock-v60__string-width__4.2.3",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__string-width__5.1.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "string-width",
    ...
    npm_import(
        name = "lock-v60__strip-ansi__6.0.1",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "strip-ansi",
    ...
    npm_import(
        name = "lock-v60__strip-ansi__7.1.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "strip-ansi",
    ...
    npm_import(
        name = "lock-v60__supports-preserve-symlinks-flag__1.0.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__typescript__5.5.2",
        root_package = "v60",
        link_workspace = "",
        link_packages = {
            "v60": ["typescript"],
    ...
    npm_import(
        name = "lock-v60__undici-types__5.26.5",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
    ...
    npm_import(
        name = "lock-v60__wrap-ansi__7.0.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "wrap-ansi",
    ...
    npm_import(
        name = "lock-v60__wrap-ansi__8.1.0",
        root_package = "v60",
        link_workspace = "",
        link_packages = {},
        package = "wrap-ansi",
