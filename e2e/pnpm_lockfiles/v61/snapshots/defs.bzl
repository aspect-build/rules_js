...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__is-odd__3.0.1__links//:defs.bzl", link_8 = "npm_link_imported_package_store", store_8 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__ms__0.7.3__links//:defs.bzl", store_12 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__rollup__3.2.5__links//:defs.bzl", link_13 = "npm_link_imported_package_store", store_13 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__sade__1.8.1__links//:defs.bzl", store_14 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__uvu__0.5.6__links//:defs.bzl", link_15 = "npm_link_imported_package_store", store_15 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_foo_jsonify__at_github.com_aspect-build_test-packages_releases_download_0.0.0_at_foo-jsonify-0.0.0.tgz__links//:defs.bzl", link_16 = "npm_link_imported_package_store", store_16 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__diff__at_github.com_kpdecker_jsdiff_archive_refs_tags_v5.2.0.tar.gz__links//:defs.bzl", store_17 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__hello__at_gitpkg.vercel.app_EqualMa_gitpkg-hello_packages_hello__links//:defs.bzl", link_18 = "npm_link_imported_package_store", store_18 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_types_archiver__5.3.1__links//:defs.bzl", link_20 = "npm_link_imported_package_store", store_20 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_types_glob__8.1.0__links//:defs.bzl", store_21 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_types_minimatch__5.1.2__links//:defs.bzl", store_22 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_types_node__16.18.11__links//:defs.bzl", link_23 = "npm_link_imported_package_store", store_23 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = []):
    ...
    if is_root:
        ...
        store_8(name = "{}/is-odd".format(name))
        store_9(name = "{}/kleur".format(name))
        store_10(name = "{}/meaning-of-life".format(name))
        store_11(name = "{}/mri".format(name))
        store_12(name = "{}/ms".format(name))
        store_13(name = "{}/rollup".format(name))
        store_14(name = "{}/sade".format(name))
        store_15(name = "{}/uvu".format(name))
        store_16(name = "{}/@foo/jsonify".format(name))
        store_17(name = "{}/diff".format(name))
        store_18(name = "{}/hello".format(name))
        store_19(name = "{}/debug".format(name))
        store_20(name = "{}/@types/archiver".format(name))
        store_21(name = "{}/@types/glob".format(name))
        store_22(name = "{}/@types/minimatch".format(name))
        store_23(name = "{}/@types/node".format(name))
    if link:
        if bazel_package == "<LOCKVERSION>":
            ...
            scope_targets["@aspect-test"] = scope_targets["@aspect-test"] + [link_targets[-1]] if "@aspect-test" in scope_targets else [link_targets[-1]]
            link_8(name = "{}/is-odd".format(name))
            ...
            link_20(name = "{}/@types/archiver".format(name))
            ...
            link_23(name = "{}/@types/node".format(name))
