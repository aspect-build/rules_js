...
def npm_imported_package_store_internal():
    _npm_imported_package_store_internal(
        ...
        deps = {
            ...
            "@aspect_rules_js//platforms/pnpm:linux_loong64": {
                ":.aspect_rules_js/node_modules/@esbuild+linux-loong64@0.27.0/pkg": "@esbuild/linux-loong64",
            },
            "@aspect_rules_js//platforms/pnpm:linux_mips64el": {
