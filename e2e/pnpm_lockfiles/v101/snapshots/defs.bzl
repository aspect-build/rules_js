...
_NPM_PACKAGE_LOCATIONS = {
    ...
    "@aspect-test/c": ["projects/peers-combo-1"],
    "@aspect-test/d": ["projects/peers-combo-1"],
    "@aspect-test/e": ["<LOCKVERSION>"],
    "@aspect-test/h": ["<LOCKVERSION>"],
    "@foo/jsonify": ["<LOCKVERSION>", "projects/peer-types"],
    "@isaacs/cliui": ["<LOCKVERSION>"],
    "@rollup/plugin-typescript": ["<LOCKVERSION>"],
    "@types/archiver": ["<LOCKVERSION>"],
    "@types/node": ["<LOCKVERSION>", "projects/a-types", "projects/b"],
    "@types/sizzle": ["<LOCKVERSION>"],
    "debug": ["<LOCKVERSION>"],
