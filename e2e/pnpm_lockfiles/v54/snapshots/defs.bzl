...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__is-core-module__2.16.0__links//:defs.bzl", store_32 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__resolve__1.22.10__links//:defs.bzl", store_46 = "npm_imported_package_store")
