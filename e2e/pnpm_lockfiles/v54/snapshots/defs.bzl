...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_types_sizzle__2.3.8__links//:defs.bzl", link_15 = "npm_link_imported_package_store", store_15 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__diff__at_github.com_kpdecker_jsdiff_archive_refs_tags_v5.2.0.tar.gz__links//:defs.bzl", store_20 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__hello__at_gitpkg.vercel.app_EqualMa_gitpkg-hello_packages_hello__links//:defs.bzl", link_25 = "npm_link_imported_package_store", store_25 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = []):
    ...
    if is_root:
        ...
        store_15(name = "{}/@types/sizzle".format(name))
    ...
    if link:
        if bazel_package == "<LOCKVERSION>":
            ...
            link_15(name = "{}/alias-only-sizzle".format(name))
