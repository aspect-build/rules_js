...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_github.com_aspect-build_test-packages_releases_download_0.0.0_foo-jsonify-0.0.0.tgz__links//:defs.bzl", link_13 = "npm_link_imported_package_store", store_13 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_github.com_kpdecker_jsdiff_archive_refs_tags_v5.2.0.tar.gz__links//:defs.bzl", store_14 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_gitpkg.vercel.app_EqualMa_gitpkg-hello_packages_hello__links//:defs.bzl", link_15 = "npm_link_imported_package_store", store_15 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_isaacs_cliui__8.0.2__links//:defs.bzl", link_16 = "npm_link_imported_package_store", store_16 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_rollup_plugin-typescript_8.2.1_3vgsug3mjv7wvue74swjdxifxy__links//:defs.bzl", link_17 = "npm_link_imported_package_store", store_17 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__at_rollup_pluginutils_3.1.0_rollup_2.14.0__links//:defs.bzl", store_18 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__dequal__2.0.3__links//:defs.bzl", store_21 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__estree-walker__1.0.1__links//:defs.bzl", store_25 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__file_.._vendored_lodash-4.17.21.tgz__links//:defs.bzl", link_26 = "npm_link_imported_package_store", store_26 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__fsevents__2.3.3__links//:defs.bzl", store_27 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__function-bind__1.1.2__links//:defs.bzl", store_28 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__github.com_jquery_jquery_399b201bb3143a3952894cf3489b4848fc003967__links//:defs.bzl", link_29 = "npm_link_imported_package_store", store_29 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__github.com_jquery_jquery_e61fccb9d736235b4b011f89cba6866bc0b8997d__links//:defs.bzl", link_30 = "npm_link_imported_package_store", store_30 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__github.com_ngokevin_debug_9742c5f383a6f8046241920156236ade8ec30d53__links//:defs.bzl", link_31 = "npm_link_imported_package_store", store_31 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__hasown__2.0.2__links//:defs.bzl", store_32 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__meaning-of-life_1.0.0_o3deharooos255qt5xdujc3cuq__links//:defs.bzl", link_41 = "npm_link_imported_package_store", store_41 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_archiver_5.3.1__links//:defs.bzl", link_46 = "npm_link_imported_package_store", store_46 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_estree_0.0.39__links//:defs.bzl", store_47 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_glob_8.1.0__links//:defs.bzl", store_48 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_minimatch_5.1.2__links//:defs.bzl", store_49 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_node_16.18.11__links//:defs.bzl", link_50 = "npm_link_imported_package_store", store_50 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~lock-<LOCKVERSION>__registry.npmjs.org_types_sizzle_2.3.9__links//:defs.bzl", link_51 = "npm_link_imported_package_store", store_51 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = []):
    ...
    if link:
        if bazel_package == "<LOCKVERSION>":
            ...
            link_15("{}/hello".format(name), link_root_name = name, link_alias = "hello")
            link_targets.append(":{}/hello".format(name))
            link_16("{}/@isaacs/cliui".format(name), link_root_name = name, link_alias = "@isaacs/cliui")
            ...
            link_17("{}/rollup-plugin-with-peers".format(name), link_root_name = name, link_alias = "rollup-plugin-with-peers")
            link_targets.append(":{}/rollup-plugin-with-peers".format(name))
            link_26("{}/lodash".format(name), link_root_name = name, link_alias = "lodash")
            link_targets.append(":{}/lodash".format(name))
            link_29("{}/jquery-git-ssh-399b201".format(name), link_root_name = name, link_alias = "jquery-git-ssh-399b201")
            link_targets.append(":{}/jquery-git-ssh-399b201".format(name))
            link_30("{}/jquery-git-ssh-e61fccb".format(name), link_root_name = name, link_alias = "jquery-git-ssh-e61fccb")
            link_targets.append(":{}/jquery-git-ssh-e61fccb".format(name))
            link_31("{}/debug".format(name), link_root_name = name, link_alias = "debug")
            link_targets.append(":{}/debug".format(name))
            link_35("{}/is-odd-v0".format(name), link_root_name = name, link_alias = "is-odd-v0")
            link_targets.append(":{}/is-odd-v0".format(name))
            link_36("{}/is-odd-v1".format(name), link_root_name = name, link_alias = "is-odd-v1")
            link_targets.append(":{}/is-odd-v1".format(name))
            link_37("{}/is-odd-v2".format(name), link_root_name = name, link_alias = "is-odd-v2")
            link_targets.append(":{}/is-odd-v2".format(name))
            link_38("{}/is-odd-v3".format(name), link_root_name = name, link_alias = "is-odd-v3")
            link_targets.append(":{}/is-odd-v3".format(name))
            link_39("{}/is-odd".format(name), link_root_name = name, link_alias = "is-odd")
            link_targets.append(":{}/is-odd".format(name))
            link_39("{}/is-odd-alias".format(name), link_root_name = name, link_alias = "is-odd-alias")
            link_targets.append(":{}/is-odd-alias".format(name))
            link_41("{}/meaning-of-life".format(name), link_root_name = name, link_alias = "meaning-of-life")
            link_targets.append(":{}/meaning-of-life".format(name))
            link_46("{}/@types/archiver".format(name), link_root_name = name, link_alias = "@types/archiver")
            ...
            link_50("{}/@types/node".format(name), link_root_name = name, link_alias = "@types/node")
            link_targets.append(":{}/@types/node".format(name))
            if "@types" not in scope_targets:
                scope_targets["@types"] = [link_targets[-1]]
            else:
                scope_targets["@types"].append(link_targets[-1])
            link_50("{}/alias-types-node".format(name), link_root_name = name, link_alias = "alias-types-node")
            link_targets.append(":{}/alias-types-node".format(name))
            link_51("{}/alias-only-sizzle".format(name), link_root_name = name, link_alias = "alias-only-sizzle")
    ...
    if bazel_package in ["<LOCKVERSION>", "projects/peer-types", "projects/peers-local-combo-1", "projects/peers-local-combo-2"]:
        # terminal target for direct dependencies
        _npm_link_package_store(
