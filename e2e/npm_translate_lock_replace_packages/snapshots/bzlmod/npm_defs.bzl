...
load("@@aspect_rules_js~~npm~npm__chalk__5.3.0__links//:defs.bzl", link_0 = "npm_link_imported_package_store", store_0 = "npm_imported_package_store")
load("@@aspect_rules_js~~npm~npm__lodash__4.17.21__links//:defs.bzl", link_1 = "npm_link_imported_package_store", store_1 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = []):
    ...
    if link:
        if bazel_package == "":
            ...
            link_1("{}/lodash".format(name), link_root_name = name, link_alias = "lodash")
