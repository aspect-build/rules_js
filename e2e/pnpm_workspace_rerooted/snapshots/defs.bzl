...
load("@@aspect_rules_js~~npm~npm__at_aspect-test_a__5.0.2__links//:defs.bzl", link_0 = "npm_link_imported_package_store_internal", store_0 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_aspect-test_b__5.0.2__links//:defs.bzl", link_1 = "npm_link_imported_package_store_internal", store_1 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_aspect-test_c__2.0.2__links//:defs.bzl", link_2 = "npm_link_imported_package_store_internal", store_2 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_aspect-test_d__2.0.0_at_aspect-test_c_2.0.2__links//:defs.bzl", link_3 = "npm_link_imported_package_store_internal", store_3 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_aspect-test_e__1.0.0__links//:defs.bzl", link_4 = "npm_link_imported_package_store_internal", store_4 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_aspect-test_f__1.0.0__links//:defs.bzl", link_5 = "npm_link_imported_package_store_internal", store_5 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_aspect-test_g__1.0.0__links//:defs.bzl", link_6 = "npm_link_imported_package_store_internal", store_6 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_aspect-test_h__1.0.0__links//:defs.bzl", link_7 = "npm_link_imported_package_store_internal", store_7 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_types_node__18.19.54__links//:defs.bzl", link_8 = "npm_link_imported_package_store_internal", store_8 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__at_types_sizzle__2.3.8__links//:defs.bzl", link_9 = "npm_link_imported_package_store_internal", store_9 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__lodash__file_.._vendored_lodash-4.17.19.tgz__links//:defs.bzl", link_10 = "npm_link_imported_package_store_internal", store_10 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__typescript__5.9.3__links//:defs.bzl", link_11 = "npm_link_imported_package_store_internal", store_11 = "npm_imported_package_store_internal")
load("@@aspect_rules_js~~npm~npm__undici-types__5.26.5__links//:defs.bzl", store_12 = "npm_imported_package_store_internal")
...
def npm_link_all_packages(name = "node_modules", imported_links = [], prod = True, dev = True):
    ...
    if is_root:
        ...
        _npm_local_package_store(
            ...
            version = "0.0.0",
            deps = {
                "//root:.aspect_rules_js/node_modules/@aspect-test+d@2.0.0_at_aspect-test_c_2.0.2": "@aspect-test/d",
