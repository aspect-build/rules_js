...
load("@@aspect_rules_js~~npm~npm__at_aspect-test_d_2.0.0_aspect-test_c_2.0.2__links//:defs.bzl", link_3 = "npm_link_imported_package_store", store_3 = "npm_imported_package_store")
...
load("@@aspect_rules_js~~npm~npm__file_vendored_lodash-4.17.19.tgz__links//:defs.bzl", link_10 = "npm_link_imported_package_store", store_10 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = []):
    ...
    if is_root:
        _npm_local_package_store(
            link_root_name = name,
            package_store_name = "file_lib+c@0.0.0",
            key = "file:lib/c",
            src = "//lib/c:pkg",
            package = "@lib/c",
            version = "0.0.0",
    ...
    if bazel_package in ["app/c"]:
        ...
        _npm_link_package_store(
            ...
            src = "//:.aspect_rules_js/{}/file_lib+c@0.0.0".format(name),
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
    ...
    if is_root:
        _npm_local_package_store(
            link_root_name = name,
            package_store_name = "file_vendored+a@0.0.0",
            key = "file:vendored/a",
            src = "//vendored/a:pkg",
            package = "vendored-a",
            version = "0.0.0",
    ...
    if bazel_package in ["lib/a"]:
        ...
        _npm_link_package_store(
            ...
            src = "//:.aspect_rules_js/{}/file_vendored+a@0.0.0".format(name),
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
    ...
    if is_root:
        _npm_local_package_store(
            link_root_name = name,
            package_store_name = "file_vendored+b_@lib+b@lib+b@0.0.0",
            key = "file:vendored/b(@lib/b@lib+b)",
            src = "//vendored/b:pkg",
            package = "vendored-b",
            version = "0.0.0",
            deps = {
                "//:.aspect_rules_js/{}/link_lib+b@0.0.0".format(name): "@lib/b",
            },
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
    ...
    if bazel_package in ["lib/a"]:
        ...
        _npm_link_package_store(
            ...
            src = "//:.aspect_rules_js/{}/file_vendored+b_@lib+b@lib+b@0.0.0".format(name),
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
    ...
    if is_root:
        _npm_local_package_store(
            link_root_name = name,
            package_store_name = "link_lib+a@0.0.0",
            key = "link:lib/a",
            src = "//lib/a:pkg",
            package = "@lib/a",
            version = "0.0.0",
            deps = {
                ...
                "//:.aspect_rules_js/{}/link_lib+b@0.0.0".format(name): "@lib/b",
                "//:.aspect_rules_js/{}/file_vendored+a@0.0.0".format(name): "vendored-a",
                "//:.aspect_rules_js/{}/file_vendored+b_@lib+b@lib+b@0.0.0".format(name): "vendored-b",
            },
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
    ...
    if bazel_package in ["app/a"]:
        ...
        _npm_link_package_store(
            ...
            src = "//:.aspect_rules_js/{}/link_lib+a@0.0.0".format(name),
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
    ...
    if is_root:
        _npm_local_package_store(
            link_root_name = name,
            package_store_name = "link_lib+b@0.0.0",
            key = "link:lib/b",
            src = "//lib/b:pkg",
            package = "@lib/b",
            version = "0.0.0",
    ...
    if bazel_package in ["app/b", "lib/a"]:
        ...
        _npm_link_package_store(
            ...
            src = "//:.aspect_rules_js/{}/link_lib+b@0.0.0".format(name),
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
    ...
    if is_root:
        _npm_local_package_store(
            link_root_name = name,
            package_store_name = "link_lib+d@0.0.0",
            key = "link:lib/d",
            src = "//lib/d:pkg",
            package = "@lib/d",
            version = "0.0.0",
            deps = {
                "//:.aspect_rules_js/{}/@aspect-test+d@2.0.0_@aspect-test+c@2.0.2".format(name): "@aspect-test/d",
    ...
    if bazel_package in ["app/d"]:
        ...
        _npm_link_package_store(
            ...
            src = "//:.aspect_rules_js/{}/link_lib+d@0.0.0".format(name),
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
