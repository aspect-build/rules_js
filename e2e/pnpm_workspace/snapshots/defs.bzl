...
def npm_link_all_packages(name = "node_modules", imported_links = [], prod = True, dev = True):
    ...
    if is_root:
        ...
        _npm_local_package_store(
            package_store_name = "vendored-a@file_vendored+a",
        ...
        _npm_local_package_store(
            package_store_name = "vendored-b@file_vendored+b_at_lib_b_lib+b",
            key = "vendored-b@file:vendored/b(@lib/b@lib+b)",
            src = "//vendored/b:pkg",
            package = "vendored-b",
            version = "file:vendored/b",
            deps = {
                "//:.aspect_rules_js/node_modules/link_lib+b@0.0.0": "@lib/b",
            },
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
        _npm_local_package_store(
            ...
            deps = {
                ...
                "//:.aspect_rules_js/node_modules/link_lib+b@0.0.0": "@lib/b",
                "//:.aspect_rules_js/node_modules/vendored-a@file_vendored+a": "vendored-a",
                "//:.aspect_rules_js/node_modules/vendored-b@file_vendored+b_at_lib_b_lib+b": "vendored-b",
            },
            visibility = ["//visibility:public"],
            tags = ["manual"],
        )
        ...
        _npm_local_package_store(
            package_store_name = "link_lib+c@0.0.0",
            key = "link:lib/c",
            src = "//lib/c:pkg",
            package = "@lib/c",
            version = "0.0.0",
...
def _fp_link_0(alias = None):
    _npm_local_link_package_store(
        ...
        package = alias,
        src = "//:.aspect_rules_js/node_modules/vendored-a@file_vendored+a",
    )
...
def _fp_link_1(alias = None):
    _npm_local_link_package_store(
        ...
        package = alias,
        src = "//:.aspect_rules_js/node_modules/vendored-b@file_vendored+b_at_lib_b_lib+b",
    )
...
def _fp_link_2(alias = None):
    _npm_local_link_package_store(
        ...
        package = alias,
        src = "//:.aspect_rules_js/node_modules/link_lib+a@0.0.0",
    )
...
def _fp_link_3(alias = None):
    _npm_local_link_package_store(
        ...
        package = alias,
        src = "//:.aspect_rules_js/node_modules/link_lib+b@0.0.0",
    )
...
def _fp_link_4(alias = None):
    _npm_local_link_package_store(
        ...
        package = alias,
        src = "//:.aspect_rules_js/node_modules/link_lib+c@0.0.0",
    )
...
def _fp_link_5(alias = None):
    _npm_local_link_package_store(
        ...
        package = alias,
        src = "//:.aspect_rules_js/node_modules/link_lib+d@0.0.0",
    )
