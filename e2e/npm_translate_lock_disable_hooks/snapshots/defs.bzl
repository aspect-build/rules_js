...
load("@@aspect_rules_js~~npm~npm__at_aspect-test_c__2.0.0__links//:defs.bzl", link_0 = "npm_link_imported_package_store_internal", store_0 = "npm_imported_package_store_internal")
