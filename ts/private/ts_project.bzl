...
Nearly identical to the ts_project wrapper macro in rules_nodejs.
Shares all the helper libraries that form the starlark implementation.
"""

load("@aspect_bazel_lib//lib:utils.bzl", "is_external_label")

# buildifier: disable=bzl-visibility
load("@rules_nodejs//nodejs/private:ts_config.bzl", "write_tsconfig")
