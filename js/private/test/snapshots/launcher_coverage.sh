...
#     @@//js/private/test:shellcheck_coverage_test
#
...
export JS_BINARY__TARGET_NAME="shellcheck_coverage_test"
export JS_BINARY__TARGET="//js/private/test:shellcheck_coverage_test"
...
export JS_BINARY__LOG_PREFIX="aspect_rules_js[js_test]"
...
if [ "${JS_BINARY__NO_RUNFILES:-}" ]; then
    ...
    JS_BINARY__NODE_WRAPPER=$(resolve_execroot_bin_path "js/private/test/shellcheck_coverage_test_node_bin/node")
else
    export JS_BINARY__NODE_WRAPPER="$JS_BINARY__RUNFILES/_main/js/private/test/shellcheck_coverage_test_node_bin/node"
fi
...
if false && [ -z "${JS_BINARY__EXPECTED_EXIT_CODE:-}" ] && [ -z "${JS_BINARY__EXIT_CODE_OUTPUT_FILE:-}" ] && [ -z "${STDOUT_CAPTURE:-}" ] && [ -z "${STDERR_CAPTURE:-}" ]; then
...
coverage_entry_point="_main/js/private/coverage/coverage.js"
