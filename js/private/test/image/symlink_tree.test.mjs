...
const symlink = node_modules_entries.get(
    `app/js/private/test/image/bin.runfiles/${process.env.TEST_WORKSPACE}/js/private/test/image/node_modules/acorn`
)
...
assert.equal(
    symlink.linkname,
    `/app/js/private/test/image/bin.runfiles/${process.env.TEST_WORKSPACE}/node_modules/.aspect_rules_js/acorn@8.8.2/node_modules/acorn`
)
