...
def _gate_and_exports():
    ...
    runfiles_group_analysis_test(
        ...
        binaries = [
            ...
            ":p6_extra_symlink_carrier_bin",
            ":p6_extra_symlink_mixed_bin",
            ":p6_extra_symlink_outer",
            ":p6_extra_symlink_npm_bin",
            ":p4_grouped_copy_lib",
            ":p6_symlink_lib",
            ":p6_fg_lib",
            ":p5_link",
...
def _nested_and_foreign():
    ...
    runfiles_group_analysis_test(
        name = "p6_extra_symlink_mixed_contract",
        binaries = [
            ":p6_extra_symlink_carrier_bin",
            ":p6_extra_symlink_mixed_bin",
            ":p6_extra_symlink_inner",
            ":p6_extra_symlink_outer",
            ":p6_extra_symlink_nested_aggregate",
            ":p6_extra_symlink_npm_bin",
        ],
        check_disabled = False,
        overlapping_group_behavior = "ignore",
