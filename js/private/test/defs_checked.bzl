...
load("@npm__at_types_node__15.14.9__links//:link_js_package.bzl", link_13 = "link_js_package")
...
load("@npm__diff__5.0.0__links//:link_js_package.bzl", link_27 = "link_js_package")
...
load("@npm__glob__7.2.0__links//:link_js_package.bzl", link_55 = "link_js_package")
...
load("@npm__mobx-react-lite__3.3.0__mobx_6.5.0_react_17.0.2__links//:link_js_package.bzl", link_69 = "link_js_package")
load("@npm__mobx-react__7.3.0__mobx_6.5.0_react_17.0.2__links//:link_js_package.bzl", link_70 = "link_js_package")
load("@npm__mobx__6.5.0__links//:link_js_package.bzl", link_71 = "link_js_package")
...
load("@npm__uvu__0.5.3__links//:link_js_package.bzl", link_90 = "link_js_package")
load("@npm__webpack-bundle-analyzer__4.5.0__bufferutil_4.0.1__links//:link_js_package.bzl", link_91 = "link_js_package")
load("@npm__wrappy__1.0.2__links//:link_js_package.bzl", link_92 = "link_js_package")
load("@npm__ws__7.5.7__bufferutil_4.0.1__links//:link_js_package.bzl", link_93 = "link_js_package")
...
def link_js_packages():
    ...
    if not is_root and not is_direct:
        msg = "The link_js_packages() macro loaded from @npm//:defs.bzl and called in bazel package '%s' may only be called in the bazel package(s) corresponding to the root package 'example' and packages corresponding to importer paths ['.']" % native.package_name()
        fail(msg)
