...
| <a id="npm_package-include_runfiles"></a>include_runfiles |  When True, default runfiles from <code>srcs</code> targets are included in the list of available files to copy.   | Boolean | optional | <code>True</code> |
