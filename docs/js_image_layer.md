...
| <a id="js_image_layer-preserve_symlinks"></a>preserve_symlinks |  Preserve symlinks matching the pattern. By default symlinks within the `node_modules` is preserved.   | String | optional |  `".*\\/node_modules\\/.*"`  |
