...
| <a id="translate_pnpm_lock-enable_lifecycle_hooks"></a>enable_lifecycle_hooks |  If true, runs lifecycle hooks on installed packages   | Boolean | optional | True |
