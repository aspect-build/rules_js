...
| <a id="npm_translate_lock-update_pnpm_lock_node_toolchain_prefix"></a>update_pnpm_lock_node_toolchain_prefix |  the prefix of the node toolchain to use when generating the pnpm lockfile.   |  <code>"nodejs"</code> |
...
| <a id="npm_translate_lock-pnpm_version"></a>pnpm_version |  pnpm version to use when generating the @pnpm repository. Set to None to not create this repository.   |  <code>"8.6.0"</code> |
