...
-   `:node_modules/{package}` - targets generated by `npm_link_all_packages()` representing each package dependency from a package.json within the workspace (normally projects within a pnpm workspace).
