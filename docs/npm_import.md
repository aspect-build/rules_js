...
npm_import(<a href="#npm_import-name">name</a>, <a href="#npm_import-package">package</a>, <a href="#npm_import-version">version</a>, <a href="#npm_import-deps">deps</a>, <a href="#npm_import-extra_build_content">extra_build_content</a>, <a href="#npm_import-transitive_closure">transitive_closure</a>, <a href="#npm_import-root_package">root_package</a>,
           <a href="#npm_import-link_workspace">link_workspace</a>, <a href="#npm_import-lifecycle_hooks">lifecycle_hooks</a>, <a href="#npm_import-lifecycle_hooks_execution_requirements">lifecycle_hooks_execution_requirements</a>,
...
| <a id="npm_import-dev"></a>dev |  Whether this npm package is a dev dependency<br><br>DEPRECATED: this field is deprecated and will be removed in a future release.<br><br>A package should be marked as a dev dependency as part of the dependency declaration, not as part of the package definition or import.   |  `False` |
